...
import { u as useTranslations, e as settingsQO } from "./router-BYgHxQI4.mjs";
...
import { B as BreadcrumbJsonLd, P as PageBreadcrumbs } from "./PageBreadcrumbs--X3SK3y_.mjs";
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen w-full overflow-x-clip bg-background text-foreground selection:bg-brand/20 selection:text-brand", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 space-y-24", children: [
      ...
      motorcycleEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rounded-3xl border border-border/80 bg-zinc-950 text-white overflow-hidden shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 items-stretch", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-6 relative min-h-[380px] sm:min-h-[460px] lg:min-h-[560px] h-full w-full overflow-hidden rounded-t-3xl lg:rounded-l-3xl lg:rounded-tr-none lg:rounded-br-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: motorcycleImage, alt: motorcycleImageAlt, loading: "eager", referrerPolicy: "no-referrer", className: "absolute inset-0 h-full w-full object-cover object-[25%_center]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-6 left-6 right-6 z-10 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/20 text-xs font-semibold uppercase tracking-wider text-accent pointer-events-auto", children: [
