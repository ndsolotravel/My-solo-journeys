...
import { u as useTranslations, q as qo$1, h as heroQO$2 } from "./router-dLf4MjiT.mjs";
...
function GalleryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "banner-hover relative h-[45vh] min-h-[280px] w-full overflow-hidden", children: [
      hero?.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: hero.image, alt: "Travel photography from the mountains.", className: "absolute inset-0 h-full w-full object-cover object-center" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 h-full w-full bg-zinc-900" }),
