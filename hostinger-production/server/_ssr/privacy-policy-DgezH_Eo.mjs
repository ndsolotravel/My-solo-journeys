...
import { u as useTranslations, a as useLanguage, R as Route$D, b as useContentTranslation } from "./router-BSNco56j.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-B9cc0eLa.mjs";
import { T as TranslatedMarkdown } from "./TranslatedMarkdown-4gAoB8pw.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "banner-hover relative h-[30vh] min-h-[220px] w-full overflow-hidden flex flex-col justify-center items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-5xl font-extrabold text-white tracking-tight drop-shadow-md", children: localizedPage.title }),
