...
import { u as useTranslations, i as useLanguage } from "./router-kn1dHUrL.mjs";
import { r as resolveMediaUrl } from "./admin.functions-DGJYtjjS.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { l as MapPin, p as Clock, J as ArrowUpRight } from "../_libs/lucide-react.mjs";
    ...
    motion.article,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block", children: [
            ...
            destination && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t(destination.title) })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-wrap items-center gap-2 text-xs text-muted-foreground", children: [
          ...
          destination && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "·" }),
