...
import { b as useServerFn, L as adminGetHomepageEditor, M as adminSaveHomepageSettings } from "./router-DDkqhyL0.mjs";
...
import "../_libs/ws.mjs";
import { h as LoaderCircle, v as Compass, ag as Eye, $ as ExternalLink, at as RotateCcw, ap as Save, b as Sparkles, aE as ImagePlus, z as Layers, aF as Rocket, aG as Maximize2, G as Globe, aH as BookMarked, X, a6 as Image, ao as Upload, aa as ChartColumn, w as Shield, p as CircleCheck, aI as ImageOff, ai as RefreshCw, f as ArrowRight, aJ as Pause, aK as Play, Z as Check, aL as Copy, o as ChevronLeft, n as ChevronRight } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full flex-col items-center justify-center gap-2.5 bg-zinc-900/60 p-4 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground max-w-xs", children: [
            "The live Homepage will use the default Unsplash hero slide for position ",
            slot,
            "."
          ] })
        ] }),
...
function LiveHeroSimulator({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden rounded-2xl border border-border bg-zinc-950 shadow-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: activeImage, alt: currentSlot.label, className: "absolute inset-0 h-full w-full object-cover object-center animate-fade-in transition-all duration-700" }, activeSlide),
...
function HeroLightbox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-black/85 p-4 sm:p-6 backdrop-blur-md animate-fade-in", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-h-[92vh] max-w-6xl w-full flex flex-col overflow-hidden rounded-2xl border border-white/15 bg-zinc-950 shadow-2xl", onClick: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 flex items-center justify-center bg-zinc-950 p-4 sm:p-6 min-h-[40vh] max-h-[72vh] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: activeSrc, alt: `${currentSlot.label} full inspection`, className: "max-h-[68vh] max-w-full rounded-lg object-contain shadow-2xl mx-auto" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 border-t border-white/10 px-5 py-3 bg-black/60 text-xs text-white/70", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 truncate max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: currentSlot.source === "auto-post" ? `Latest published post: "${currentSlot.postTitle || "Post"}"` : currentSlot.src ? "Custom Manual URL" : "Default Unsplash Fallback Slide" })
      ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-2", children: [
            ...
            heroImagesMode === "manual" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-2", children: [
              HERO_IMAGE_FIELDS.map((field) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 rounded-xl border border-border/80 bg-background/50 p-4 shadow-2xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value, onChange: (e) => set(field.key, e.target.value), placeholder: "…or paste image URL directly", className: "flex-1 min-w-48 rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm text-foreground outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
                  ] })
                ] }, field.key);
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Tip: Any empty slot automatically falls back to the default Unsplash hero slide on the live site." })
            ] })
          ] }),
