...
import { u as useTranslations, f as settingsQO } from "./router-CVJpNB8L.mjs";
...
import { B as BreadcrumbJsonLd, P as PageBreadcrumbs } from "./PageBreadcrumbs-DaB9ywqu.mjs";
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen w-full overflow-x-clip bg-background text-foreground selection:bg-brand/20 selection:text-brand", children: [
    ...
    heroEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "banner-hover relative min-h-[50vh] lg:min-h-[58vh] w-full flex items-end overflow-hidden bg-zinc-950", children: [
