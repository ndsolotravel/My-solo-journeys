...
import { d as useServerFn, Y as adminGetHomepageEditor, Z as adminSaveHomepageSettings } from "./router-B6m4P0F8.mjs";
...
import "../_libs/ws.mjs";
import { j as LoaderCircle, N as Compass, E as Eye, w as ExternalLink, R as RotateCcw, ay as Save, d as Sparkles, q as ImagePlus, a0 as Layers, b0 as Rocket, t as Maximize2, G as Globe, b1 as BookMarked, X, ap as Image, aL as Upload, as as ChartColumn, af as Earth, V as Bike, r as Camera, Z as Route, v as Calendar, O as Shield, y as CircleCheck, b2 as ImageOff, aF as RefreshCw, h as ArrowRight, x as ChevronLeft, p as ChevronRight, b3 as Pause, b4 as Play, C as Check, b5 as Copy } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 flex items-end justify-between gap-2 p-3 text-white pointer-events-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-xs sm:text-sm font-semibold text-white/95", children: postTitle || caption || `Hero Background ${slot}` })
          ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden rounded-2xl border border-border bg-zinc-950 shadow-md", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-4 bottom-14 sm:bottom-16 max-w-2xl text-white space-y-2 pointer-events-none z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg sm:text-2xl lg:text-3xl font-bold leading-tight drop-shadow-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: draft.homepage_hero_title || "Stories from the high places" }),
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: draft.homepage_hero_title_highlight || "Most people only fly over." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-white/85 line-clamp-2 leading-relaxed drop-shadow-sm max-w-xl", children: draft.homepage_hero_description || "Welcome to NDSOLOTRAVEL, a personal travel journal covering solo travel, motorcycle adventures, and mountain treks across Pakistan, the Karakoram, and around the world." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full bg-btn-bg px-3.5 py-1.5 text-xs font-semibold text-btn-text shadow-md", children: [
...
function AdminHomepagePage() {
  ...
  const computedCountries = data?.computedCountries ?? 0;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Homepage Management" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-4 border-b border-border/60 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-lg font-semibold flex items-center gap-2 text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, className: "grid gap-6 lg:grid-cols-[1fr_340px]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 pt-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 sm:col-span-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "The second phrase of the title, highlighted in accent color (#4085FF)." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 sm:col-span-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 border-b border-border/60 pb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 text-xs text-muted-foreground", children: "The stats strip (countries covered in blogs, trips, photos, kilometres, days) above the newsletter." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-accent/10 px-2.5 py-0.5 text-xs font-medium text-accent", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "h-3 w-3" }),
              " Public"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-medium text-foreground", children: "Countries Covered in Blogs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2 sm:grid-cols-2", children: [
            ...
            draft.homepage_stat_countries_mode === "manual" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 pt-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "homepage_stat_countries", type: "number", min: 0, placeholder: "27", value: draft.homepage_stat_countries ?? "", onChange: (e) => set("homepage_stat_countries", e.target.value), className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: 'The homepage and the Expedition Stats widget display this exact number as the "Countries Covered in Blogs" count.' })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 rounded-xl border border-accent/25 bg-accent/5 p-4 space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
                  computedCountries,
                  " ",
                  computedCountries === 1 ? "country" : "countries"
                ] }),
                ", computed from the locations of published blog posts."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Switch to Manual to pin a fixed number instead." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: draft.homepage_stat_trips_suffix ?? "+", onChange: (e) => set("homepage_stat_trips_suffix", e.target.value), placeholder: "+", className: "w-20 rounded-xl border border-border bg-background px-3 py-2.5 text-sm font-medium text-center outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors", title: "Suffix (e.g. +)" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: draft.homepage_stat_kilometres_suffix ?? "km", onChange: (e) => set("homepage_stat_kilometres_suffix", e.target.value), placeholder: "km", className: "w-20 rounded-xl border border-border bg-background px-3 py-2.5 text-sm font-medium text-center outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors", title: "Suffix (e.g. km)" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: draft.homepage_stat_photos_suffix ?? "K+", onChange: (e) => set("homepage_stat_photos_suffix", e.target.value), placeholder: "K+", className: "w-20 rounded-xl border border-border bg-background px-3 py-2.5 text-sm font-medium text-center outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors", title: "Suffix (e.g. K+)" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: draft.homepage_stat_days_suffix ?? "+", onChange: (e) => set("homepage_stat_days_suffix", e.target.value), placeholder: "+", className: "w-20 rounded-xl border border-border bg-background px-3 py-2.5 text-sm font-medium text-center outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors", title: "Suffix (e.g. +)" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/70 bg-muted/20 p-4 sm:p-5 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-foreground flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-3.5 w-3.5 text-accent" }),
                "Live Section Preview (How it renders on the Homepage)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: "Synchronized with draft" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 w-full min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-3 sm:p-4 transition-all hover:border-accent/40 w-full min-w-0 overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-xl bg-accent/10 text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Earth, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2.5 sm:mt-3 font-sans text-lg sm:text-xl lg:text-2xl font-bold text-foreground tabular-nums whitespace-nowrap", children: draft.homepage_stat_countries_mode === "manual" ? draft.homepage_stat_countries?.trim() || "27" : computedCountries }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 sm:mt-1 text-[11px] sm:text-xs text-muted-foreground leading-snug", children: "Countries Covered in Blogs" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-3 sm:p-4 transition-all hover:border-accent/40 w-full min-w-0 overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-xl bg-accent/10 text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bike, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5 sm:mt-3 font-sans text-lg sm:text-xl lg:text-2xl font-bold text-foreground tabular-nums whitespace-nowrap", children: [
                  draft.homepage_stat_trips || "102",
                  draft.homepage_stat_trips_suffix ?? "+"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 sm:mt-1 text-[11px] sm:text-xs text-muted-foreground leading-snug", children: "Solo Motorcycle Trips" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-3 sm:p-4 transition-all hover:border-accent/40 w-full min-w-0 overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-xl bg-accent/10 text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5 sm:mt-3 font-sans text-lg sm:text-xl lg:text-2xl font-bold text-foreground tabular-nums whitespace-nowrap", children: [
                  draft.homepage_stat_photos || "200",
                  draft.homepage_stat_photos_suffix || "K+"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 sm:mt-1 text-[11px] sm:text-xs text-muted-foreground leading-snug", children: "Photos Captured" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-accent/40 bg-card p-3 sm:p-4 transition-all hover:border-accent/60 w-full min-w-0 overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-xl bg-accent/10 text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5 sm:mt-3 font-sans text-lg sm:text-xl lg:text-2xl font-bold text-foreground tabular-nums whitespace-nowrap", children: [
                  Number(draft.homepage_stat_kilometres || "18420").toLocaleString(),
                  draft.homepage_stat_kilometres_suffix || "km"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 sm:mt-1 text-[11px] sm:text-xs text-muted-foreground leading-snug", children: "Kilometres Travelled" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 sm:col-span-1 rounded-2xl border border-border bg-card p-3 sm:p-4 transition-all hover:border-accent/40 w-full min-w-0 overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-xl bg-accent/10 text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5 sm:mt-3 font-sans text-lg sm:text-xl lg:text-2xl font-bold text-foreground tabular-nums whitespace-nowrap", children: [
                  draft.homepage_stat_days || "142",
                  draft.homepage_stat_days_suffix ?? "+"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 sm:mt-1 text-[11px] sm:text-xs text-muted-foreground leading-snug", children: "Days on the Road" })
              ] })
            ] })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden rounded-xl border border-border bg-zinc-950", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-black/40 flex flex-col justify-end p-3 text-white", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xs sm:text-sm font-bold leading-tight mt-0.5 line-clamp-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-semibold flex items-center gap-2 text-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground", children: "CMS Tips" }),
