...
import { d as useServerFn, C as CATEGORIES } from "./router-B5b4WQf1.mjs";
import { f as useNavigate } from "../_libs/tanstack__react-router.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { adminUpsertPost, adminUploadImage, adminDeleteGalleryImage, adminSavePostGallery, adminListDestinations, adminDetectDestination, adminUpdatePostCoordinates } from "./admin.functions-DqDOVcL1.mjs";
...
import { ae as Image, h as LoaderCircle, ay as Upload, aV as FileImage, b4 as GripVertical, r as Maximize2, u as ChevronLeft, n as ChevronRight, aw as Trash2, X, G as Globe, v as CircleCheck, i as CircleAlert, aE as TriangleAlert, S as Search, b5 as Monitor, b1 as Smartphone, K as KeyRound, ab as Tag, U as User, m as MapPin, af as Navigation, av as CircleX, t as Calendar, B as Compass, b as Sparkles, E as ExternalLink, ax as Save, a7 as BookOpen, aJ as Bold, aK as Italic, aL as Heading2, ad as List, aO as Link, aI as PenLine, ap as Eye, a8 as ChevronDown } from "../_libs/lucide-react.mjs";
      ...
      (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 sm:p-6 space-y-6 shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 border-b border-border/70 pb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display text-base sm:text-lg font-semibold flex items-center gap-2 text-foreground", children: [
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-[#303134] border border-border/50 text-[10px] font-bold text-[#FF7A00]", children: "ND" }),
