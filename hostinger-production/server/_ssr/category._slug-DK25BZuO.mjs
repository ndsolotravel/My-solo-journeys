...
import { u as useTranslations, n as Route$i } from "./router-D9Nbuboh.mjs";
import { r as resolveMediaUrl } from "./admin.functions-DGJYtjjS.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { W as FolderTree, Q as BookOpen, Z as Layers, r as ArrowLeft } from "../_libs/lucide-react.mjs";
...
function CategoryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "min-h-screen pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[48vh] min-h-[360px] w-full overflow-hidden bg-zinc-950", children: [
