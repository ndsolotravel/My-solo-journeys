...
import { d as useServerFn } from "./router-B6m4P0F8.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { a as adminListCategories, b as adminUpsertCategory, c as adminDeleteCategory, s as slugify } from "./categories.functions-BG32lH_N.mjs";
...
import "../_libs/ws.mjs";
import { an as FolderTree, aP as Plus, a as Search, X, j as LoaderCircle, a0 as Layers, w as ExternalLink, n as FileText, aQ as Pencil, aK as Trash2, d as Sparkles, aL as Upload, G as Globe, aR as TriangleAlert, ap as Image } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-7xl mx-auto pb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-2xl bg-brand/10 text-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderTree, { className: "h-6 w-6 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Category Management" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Create, organize, and manage blog categories with auto-slugs and post associations." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: openCreateModal, className: "inline-flex items-center gap-2 rounded-xl bg-brand px-5 py-2 text-xs font-semibold text-white shadow-md shadow-brand/20 hover:bg-brand/90 transition-all cursor-pointer self-start sm:self-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Add Category" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between rounded-2xl border border-border bg-card p-4 shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search categories by name, slug or description…", className: "w-full rounded-xl border border-border bg-background pl-9 pr-8 py-2 text-xs font-medium placeholder:text-muted-foreground/60 outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
        search && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setSearch(""), className: "absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3.5 w-3.5" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex rounded-xl border border-border bg-background p-1 text-xs font-medium", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setStatusFilter("all"), className: `rounded-lg px-3 py-1.5 transition-all cursor-pointer ${statusFilter === "all" ? "bg-brand text-white font-semibold shadow-2xs" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`, children: [
          "All (",
          categories.length,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setStatusFilter("active"), className: `rounded-lg px-3 py-1.5 transition-all cursor-pointer ${statusFilter === "active" ? "bg-brand text-white font-semibold shadow-2xs" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`, children: [
          "Active (",
          categories.filter((c) => c.status === "active").length,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setStatusFilter("inactive"), className: `rounded-lg px-3 py-1.5 transition-all cursor-pointer ${statusFilter === "inactive" ? "bg-brand text-white font-semibold shadow-2xs" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`, children: [
          "Inactive (",
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-muted-foreground", children: [
    ...
    ] }) : filteredCategories.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-dashed border-border py-12 text-center bg-card shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-2xl bg-brand/10 text-brand mx-auto mb-3 w-fit", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderTree, { className: "h-6 w-6 text-accent" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground", children: "No categories found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 max-w-sm mx-auto", children: search ? "No categories match your search terms." : "Start by adding your first travel blog category." }),
      !search && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: openCreateModal, className: "mt-4 inline-flex items-center gap-2 rounded-xl bg-brand px-5 py-2 text-xs font-semibold text-white shadow-md shadow-brand/20 hover:bg-brand/90 transition-all cursor-pointer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" }),
        " Create Category"
      ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: filteredCategories.map((c) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "group hover:bg-muted/30 transition-colors", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-semibold ${c.status === "active" ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/25" : "bg-muted text-muted-foreground border border-border/60"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `h-1.5 w-1.5 rounded-full ${c.status === "active" ? "bg-emerald-500" : "bg-zinc-400"}` }),
            c.status === "active" ? "Active" : "Inactive"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/admin/posts", title: "View posts in this category", className: `inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-medium transition-colors ${postCount > 0 ? "bg-accent/10 text-accent hover:bg-accent/20 border border-accent/20" : "bg-muted text-muted-foreground border border-border/60"}`, children: [
    ...
    editing && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl overflow-hidden rounded-3xl border border-border bg-card shadow-2xl animate-in fade-in zoom-in-95 duration-200", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-6 py-4 bg-muted/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold", children: editing.id ? "Edit Category" : "Create New Category" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            }, placeholder: "e.g. Motorcycle Journeys", className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
              ...
              }, className: "text-[11px] text-accent hover:underline flex items-center gap-1 cursor-pointer font-medium", children: [
            ...
            }, placeholder: "e.g. motorcycle-journeys", className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-mono outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          } : prev), placeholder: "Brief summary of what stories belong to this category…", className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors resize-y" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            } : prev), className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            } : prev), className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            ...
            } : prev), placeholder: "https://… or storage URL", className: "flex-1 rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex items-center gap-1.5 rounded-xl border border-border bg-muted px-4 py-2.5 text-xs font-semibold text-foreground hover:bg-muted/80 transition-colors cursor-pointer shrink-0 shadow-2xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-muted/20 p-4 space-y-3.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            } : prev), placeholder: `${editing.name || "Category"} — ndsolotravel`, className: "w-full rounded-xl border border-border bg-background px-3.5 py-2 text-xs font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            } : prev), placeholder: editing.description || "Search snippet description displayed in Google results…", className: "w-full rounded-xl border border-border bg-background px-3.5 py-2 text-xs font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors resize-y" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky bottom-0 z-10 flex items-center justify-end gap-3 pt-3 pb-3 px-6 -mx-6 -mb-6 border-t border-border bg-card/95 backdrop-blur-md shadow-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setEditing(null), className: "rounded-xl border border-border bg-card px-4 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors cursor-pointer", children: "Cancel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: saveMutation.isPending, className: "inline-flex items-center gap-2 rounded-xl bg-brand px-5 py-2 text-xs font-semibold text-white shadow-md shadow-brand/20 hover:bg-brand/90 disabled:opacity-50 transition-all cursor-pointer", children: saveMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTarget, onOpenChange: (open) => !open && setDeleteTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "rounded-3xl border border-border bg-card shadow-2xl p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-amber-500", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "text-lg font-bold text-foreground", children: deleteTarget && (deleteTarget.post_count ?? 0) > 0 ? "Cannot Delete Category" : "Delete Category?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { className: "text-xs text-muted-foreground space-y-2 mt-2", children: deleteTarget && (deleteTarget.post_count ?? 0) > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { className: "mt-4 flex items-center justify-end gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { className: "rounded-xl border border-border bg-card px-4 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors cursor-pointer", children: deleteTarget && (deleteTarget.post_count ?? 0) > 0 ? "Understood" : "Cancel" }),
        deleteTarget && (deleteTarget.post_count ?? 0) === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { disabled: delMutation.isPending, className: "rounded-xl bg-red-600 px-4 py-2 text-xs font-semibold text-white shadow-md hover:bg-red-700 disabled:opacity-50 transition-all cursor-pointer", onClick: () => deleteTarget && delMutation.mutate(deleteTarget.id), children: delMutation.isPending ? "Deleting…" : "Delete Category" })
      ] })
    ] }) })
  ] });
}
