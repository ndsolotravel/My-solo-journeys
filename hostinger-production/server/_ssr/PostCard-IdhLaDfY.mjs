...
import { u as useTranslations, a as useLanguage } from "./router-B6m4P0F8.mjs";
import { r as resolveMediaUrl } from "./media-5OPpyOwL.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { o as MapPin, z as Clock, ai as ArrowUpRight } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.article,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-wrap items-center gap-2 text-caption", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: { slug: post.slug }, className: "block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1.5 text-h3 text-heading group-hover:text-link-hover transition-colors", children: localizedPost.title }),
          localizedPost.excerpt && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 line-clamp-2 text-body", children: localizedPost.excerpt }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mt-2 inline-flex items-center gap-1 text-xs font-medium text-link transition-colors group-hover:text-link-hover", children: [
            t("Read story"),
