...
import { u as useTranslations, g as Route$o, h as blogQO, k as categoriesQO, C as CATEGORIES, m as authorNameQO$1, i as destQO, j as activeTopicsQO } from "./router-DF-pQyIn.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { b as useSuspenseQuery, a as useQuery } from "../_libs/tanstack__react-query.mjs";
import { P as PostCard } from "./PostCard-0U4i-wG2.mjs";
import { P as PageBreadcrumbs, B as BreadcrumbJsonLd } from "./PageBreadcrumbs-azIQtDtE.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { b as Sparkles, q as Clock, m as MapPin, f as ArrowRight, S as Search, a1 as SlidersHorizontal } from "../_libs/lucide-react.mjs";
...
function BlogIndex() {
  ...
  const search = Route$o.useSearch();
  const navigate = Route$o.useNavigate();
  const {
    data
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: activeTopics.map((topic) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/topics/$slug", params: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-36 overflow-hidden", children: [
            (() => {
              ...
              return img ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img, alt: topic.title, className: "h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full bg-zinc-900" });
            })(),
