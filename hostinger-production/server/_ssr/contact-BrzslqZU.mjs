...
import { u as useTranslations, a as useServerFn, s as sendContact, S as SITE } from "./router-D9Nbuboh.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-DyVuLgC_.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { c as Mail, o as CircleCheck, g as LoaderCircle, l as MapPin, p as Clock, I as Instagram, Y as Youtube, T as Twitter, F as Facebook, a as Linkedin } from "../_libs/lucide-react.mjs";
...
function ContactPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground w-full min-w-0 overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[38vh] min-h-[260px] sm:min-h-[300px] w-full overflow-hidden flex flex-col justify-center items-center", children: [
