...
import { u as useTranslations, f as Route$n, g as blogQO, j as categoriesQO, C as CATEGORIES, k as authorNameQO$1, h as destQO, i as activeTopicsQO } from "./router-BbnFzWay.mjs";
...
import { P as PageBreadcrumbs, B as BreadcrumbJsonLd } from "./PageBreadcrumbs-CWiEbxpz.mjs";
...
function BlogIndex() {
  ...
  const navigate = Route$n.useNavigate();
  const {
    data
