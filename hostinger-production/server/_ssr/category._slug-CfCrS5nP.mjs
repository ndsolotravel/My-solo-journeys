...
import { u as useTranslations, v as Route$n } from "./router-B6m4P0F8.mjs";
import { r as resolveMediaUrl } from "./media-5OPpyOwL.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import "../_libs/sonner.mjs";
import { an as FolderTree, ac as BookOpen, a0 as Layers, u as ArrowLeft } from "../_libs/lucide-react.mjs";
...
function CategoryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "min-h-screen pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner-hover relative h-[48vh] min-h-[360px] w-full overflow-hidden bg-zinc-950", children: [
      heroImage ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImage, alt: category.name, className: "h-full w-full object-cover opacity-60" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-zinc-900" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 mx-auto max-w-5xl px-4 pb-10 sm:px-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 font-display text-3xl font-bold tracking-tight text-foreground sm:text-5xl", children: t(category.name) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-10 max-w-5xl px-4 sm:px-6", children: [
      posts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border pb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-sans tabular-nums", children: [
            t("Showing"),
            " ",
            posts.length,
            " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: t("No stories in this category yet") }),
