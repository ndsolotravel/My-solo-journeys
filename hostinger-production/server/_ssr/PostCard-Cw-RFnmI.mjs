...
import { m as MapPin, w as Clock, a5 as ArrowUpRight } from "../_libs/lucide-react.mjs";
    ...
    motion.article,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: { slug: post.slug }, className: "block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1.5 font-display text-xl font-medium leading-snug group-hover:text-accent transition-colors", children: localizedPost.title }),
