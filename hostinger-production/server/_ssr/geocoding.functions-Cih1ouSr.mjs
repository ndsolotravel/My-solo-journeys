...
const KNOWN_DESTINATIONS = [{
  patterns: [/\bk[- ]?2\s*(base\s*camp|concordia)?\b/i, /\bconcordia\s*(diaries|camp|glacier)?\b/i, /\bgodwin[- ]austen\b/i],
  locationName: "K2 Base Camp, Concordia",
  latitude: 35.7444,
  longitude: 76.525,
  displayName: "Concordia, Karakoram, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bnanga\s*parbat\b/i, /\bkiller\s*mountain\b/i, /\bdiamer\b/i, /\braikot\b/i, /\brupal\s*face\b/i],
  locationName: "Nanga Parbat, Diamer",
  latitude: 35.2375,
  longitude: 74.5892,
  displayName: "Nanga Parbat, Diamer, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bphander\s*(valley|lake)?\b/i, /\bphandar\b/i],
  locationName: "Phander Valley, Ghizer",
  latitude: 36.1793,
  longitude: 73.7512,
  displayName: "Phander Valley, Ghizer, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\b(high\s*)?himalayas?\b/i, /\bnepal\b/i, /\bannapurna\b/i, /\beverest\b/i, /\bkhumbu\b/i],
  locationName: "High Himalaya, Nepal",
  latitude: 27.9881,
  longitude: 86.925,
  displayName: "High Himalaya, Nepal"
}, {
  patterns: [/\bkarakoram(\s*highway|\s*range)?\b/i, /\bkkh\b/i, /\bskardu\b/i, /\bbaltistan\b/i],
  locationName: "Karakoram, Skardu",
  latitude: 35.2971,
  longitude: 75.6333,
  displayName: "Karakoram, Skardu, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bfairy\s*meadows?\b/i, /\bjhel\b/i, /\bbeyal\s*camp\b/i],
  locationName: "Fairy Meadows, Diamer",
  latitude: 35.385,
  longitude: 74.5778,
  displayName: "Fairy Meadows, Diamer, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bhunza(\s*valley)?\b/i, /\bkarimabad\b/i, /\baltit(\s*fort)?\b/i, /\bbaltit(\s*fort)?\b/i, /\bduikar\b/i, /\beagle['’]?s\s*nest\b/i],
  locationName: "Hunza Valley, Gilgit-Baltistan",
  latitude: 36.3167,
  longitude: 74.65,
  displayName: "Hunza Valley, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bdeosai(\s*plains?|\s*national\s*park)?\b/i, /\bsheosar(\s*lake)?\b/i, /\bland\s*of\s*giants\b/i],
  locationName: "Deosai Plains, Skardu",
  latitude: 35.0306,
  longitude: 75.4414,
  displayName: "Deosai National Park, Skardu, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bpassu(\s*cones?|\s*cathedrals?|\s*glacier)?\b/i, /\bupper\s*hunza\b/i, /\bgojal\b/i, /\bhussaini(\s*suspension)?\s*bridge\b/i],
  locationName: "Passu Cones, Gojal",
  latitude: 36.474,
  longitude: 74.887,
  displayName: "Passu, Gojal, Upper Hunza, Pakistan"
}, {
  patterns: [/\battabad(\s*lake)?\b/i],
  locationName: "Attabad Lake, Hunza",
  latitude: 36.3389,
  longitude: 74.8694,
  displayName: "Attabad Lake, Gojal, Hunza, Pakistan"
}, {
  patterns: [/\bkhunjerab(\s*pass)?\b/i, /\bpak[- ]china\s*border\b/i],
  locationName: "Khunjerab Pass, Karakoram Highway",
  latitude: 36.8497,
  longitude: 75.4244,
  displayName: "Khunjerab Pass, Pakistan-China Border, Pakistan"
}, {
  patterns: [/\bseychelles\b/i, /\bmah[eé]\b/i, /\bpraslin\b/i, /\bla\s*digue\b/i, /\bvictoria\b/i, /\banse\s*(source|lazio|georgette|cocos|major)\b/i],
  locationName: "Seychelles Islands",
  latitude: -4.6796,
  longitude: 55.492,
  displayName: "Mahé, Praslin, La Digue, Seychelles"
}, {
  patterns: [/\brakaposhi(\s*base\s*camp|\s*view\s*point)?\b/i, /\bnagar(\s*valley)?\b/i, /\bminapin\b/i],
  locationName: "Rakaposhi Base Camp, Nagar",
  latitude: 36.1408,
  longitude: 74.4908,
  displayName: "Rakaposhi, Nagar Valley, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bbaltoro(\s*glacier)?\b/i, /\bpaiju\b/i, /\burdukas\b/i, /\bgoro\s*ii\b/i],
  locationName: "Baltoro Glacier, Karakoram",
  latitude: 35.7333,
  longitude: 76.4,
  displayName: "Baltoro Glacier, Karakoram, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bshimshal(\s*valley|\s*pass)?\b/i, /\bminglik\s*sar\b/i],
  locationName: "Shimshal Valley, Hunza",
  latitude: 36.4389,
  longitude: 75.3194,
  displayName: "Shimshal Valley, Upper Hunza, Pakistan"
}, {
  patterns: [/\bghizer(\s*valley)?\b/i, /\bgupis\b/i, /\bkhalti\s*lake\b/i],
  locationName: "Ghizer Valley, Gilgit-Baltistan",
  latitude: 36.2167,
  longitude: 73.6667,
  displayName: "Ghizer Valley, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\byasin(\s*valley)?\b/i, /\bdarkot\b/i],
  locationName: "Yasin Valley, Ghizer",
  latitude: 36.3667,
  longitude: 73.35,
  displayName: "Yasin Valley, Ghizer, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bbroghil(\s*valley|\s*national\s*park)?\b/i, /\bkarambar\s*lake\b/i],
  locationName: "Broghil Valley, Upper Chitral",
  latitude: 36.8333,
  longitude: 73.4167,
  displayName: "Broghil Valley, Upper Chitral, Pakistan"
}, {
  patterns: [/\bkalash(\s*valleys?|\s*people)?\b/i, /\bbumburet\b/i, /\brumbur\b/i, /\bbirir\b/i, /\bchitral\b/i],
  locationName: "Kalash Valley, Chitral",
  latitude: 35.7,
  longitude: 71.6833,
  displayName: "Kalash Valley, Chitral, Khyber Pakhtunkhwa, Pakistan"
}, {
  patterns: [/\bswat(\s*valley)?\b/i, /\bkalam\b/i, /\bmalam\s*jabba\b/i, /\bmahudand\s*lake\b/i, /\bumanr\b/i],
  locationName: "Swat Valley, Khyber Pakhtunkhwa",
  latitude: 35.2227,
  longitude: 72.4258,
  displayName: "Swat Valley, Khyber Pakhtunkhwa, Pakistan"
}, {
  patterns: [/\bkumrat(\s*valley)?\b/i, /\bthal\b/i, /\bjandrai\b/i, /\bkatora\s*lake\b/i],
  locationName: "Kumrat Valley, Upper Dir",
  latitude: 35.5333,
  longitude: 72.2167,
  displayName: "Kumrat Valley, Upper Dir, Khyber Pakhtunkhwa, Pakistan"
}, {
  patterns: [/\bbabusar(\s*pass|\s*top)?\b/i, /\bkaghan(\s*valley)?\b/i, /\bnaran\b/i, /\bsaif[- ]ul[- ]mal[ou]{2}k\b/i, /\blulusar\b/i],
  locationName: "Babusar Pass, Kaghan Valley",
  latitude: 35.1481,
  longitude: 74.0489,
  displayName: "Babusar Pass, Kaghan Valley, Pakistan"
}, {
  patterns: [/\bneelum(\s*valley)?\b/i, /\barang\s*kel\b/i, /\bratti\s*gali(\s*lake)?\b/i, /\bsharda\b/i, /\bkeran\b/i],
  locationName: "Neelum Valley, Azad Kashmir",
  latitude: 34.5889,
  longitude: 73.9056,
  displayName: "Neelum Valley, Azad Kashmir, Pakistan"
}, {
  patterns: [/\brush\s*lake\b/i, /\brush\s*peak\b/i],
  locationName: "Rush Lake, Nagar",
  latitude: 36.15,
  longitude: 74.9167,
  displayName: "Rush Lake, Nagar Valley, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bkatpana(\s*desert|\s*cold\s*desert)?\b/i, /\bshangrila(\s*resort)?\b/i, /\blower\s*kachura\b/i, /\bupper\s*kachura\b/i],
  locationName: "Skardu, Katpana Cold Desert",
  latitude: 35.3208,
  longitude: 75.5947,
  displayName: "Katpana Desert, Skardu, Gilgit-Baltistan, Pakistan"
}, {
  patterns: [/\bastola\s*island\b/i, /\bhingol(\s*national\s*park)?\b/i, /\bprincess\s*of\s*hope\b/i, /\bkund\s*malir\b/i],
  locationName: "Hingol, Balochistan",
  latitude: 25.52,
  longitude: 65.52,
  displayName: "Hingol National Park, Balochistan, Pakistan"
}, {
  patterns: [/\bgorakh\s*hill\b/i],
  locationName: "Gorakh Hill Station, Sindh",
  latitude: 26.8667,
  longitude: 67.15,
  displayName: "Gorakh Hill Station, Dadu, Sindh, Pakistan"
}, {
  patterns: [/\bmargalla(\s*hills)?\b/i, /\bislamabad\b/i],
  locationName: "Margalla Hills, Islamabad",
  latitude: 33.7439,
  longitude: 73.0239,
  displayName: "Margalla Hills, Islamabad, Pakistan"
}, {
  patterns: [/\blahore\b/i, /\bbadshahi\s*mosque\b/i],
  locationName: "Lahore, Punjab",
  latitude: 31.5204,
  longitude: 74.3587,
  displayName: "Lahore, Punjab, Pakistan"
}, {
  patterns: [/\bkarachi\b/i, /\bclifton\s*beach\b/i],
  locationName: "Karachi, Sindh",
  latitude: 24.8607,
  longitude: 67.0011,
  displayName: "Karachi, Sindh, Pakistan"
}];
const COMMON_NOISE_WORDS = /* @__PURE__ */ new Set(["the", "a", "an", "and", "or", "but", "in", "on", "at", "to", "for", "of", "with", "by", "from", "is", "was", "are", "were", "be", "been", "being", "have", "has", "had", "do", "does", "did", "will", "would", "could", "should", "may", "might", "shall", "can", "need", "dare", "ought", "used", "my", "your", "his", "her", "its", "our", "their", "this", "that", "these", "those", "i", "you", "he", "she", "it", "we", "they", "me", "him", "her", "us", "them", "what", "which", "who", "whom", "whose", "when", "where", "why", "how", "all", "each", "every", "both", "few", "more", "most", "other", "some", "such", "no", "not", "only", "own", "same", "so", "than", "too", "very", "just", "about", "above", "after", "again", "against", "as", "because", "before", "below", "between", "into", "through", "during", "out", "off", "over", "under", "further", "then", "once", "here", "there", "if", "story", "stories", "travel", "travelling", "traveller", "solo", "trip", "journey", "adventure", "guide", "tips", "best", "top", "ultimate", "complete", "perfect", "amazing", "incredible", "beautiful", "stunning", "breathtaking", "magical", "unforgettable", "exploring", "explore", "discover", "discovering", "hidden", "secret", "remote", "wild", "epic", "part", "first", "second", "third", "experience", "escape", "road", "trek", "trekking", "hike", "hiking", "camp", "camping", "visit", "destination", "spot", "budget", "day", "days", "week", "weeks", "month", "months", "year", "years", "diaries", "diary", "photographing", "photography", "photos", "light", "cold", "patience", "killer", "mountain", "three", "chasing", "autumn", "summer", "winter", "spring"]);
...
function cleanPhrase(text) {
  return text.replace(/[«»""''‘’“”]/g, "").replace(/\$\d+(\s*(a|per)\s*day)?/gi, "").replace(/\b(solo\s+to|chasing\s+autumn\s+in|trekking|budget\s+travel\s+in|photographing\s+the|a\s+week\s+in|three\s+weeks\s+at|guide\s+to|exploring|road\s+trip\s+to|the\s+killer\s+mountain|the\s+concordia\s+diaries|light,\s*cold,\s*and\s*patience)\b/gi, " ").replace(/\b(the|a|an|in|at|on|to|for|of|with|by|from|part\s*\d+|part\s*(one|two|three))\b/gi, " ").replace(/[^\w\s]/g, " ").replace(/\s+/g, " ").trim();
}
function matchKnownDestination(title) {
...
function determineConfidence(result, originalQuery) {
  ...
  const highPriorityTypes = ["city", "town", "village", "hamlet", "municipality", "county", "state", "province", "region", "country", "mountain", "peak", "hill", "valley", "lake", "river", "island", "beach", "national_park", "park", "reserve", "forest", "glacier"];
...
const geocodeFromTitle_createServerFn_handler = createServerRpc({
  id: "da53071c043974edb87b45468eb1066dcad45591f0fb1880a2e95813077c29f6",
  name: "geocodeFromTitle",
  filename: "src/lib/geocoding.functions.ts"
}, (opts) => geocodeFromTitle.__executeServer(opts));
...
}).parse(i)).handler(geocodeFromTitle_createServerFn_handler, async ({
  data
}) => {
  const {
    title,
...
const batchGeocodePosts_createServerFn_handler = createServerRpc({
  id: "70249fd9edc70eb0216923df688219c195e96caa63793da4ffd57748f5ccbdb3",
  name: "batchGeocodePosts",
  filename: "src/lib/geocoding.functions.ts"
}, (opts) => batchGeocodePosts.__executeServer(opts));
const batchGeocodePosts = createServerFn({
...
}).parse(i)).handler(batchGeocodePosts_createServerFn_handler, async ({
  context,
  data
}) => {
  const client = context.supabase ?? (await import("./client.server-CVdEp4yu.mjs")).supabaseAdmin;
  let query = client.from("posts").select("id, title, location_name, latitude, longitude");
  ...
  for (const post of posts) {
    if (!data.forceAll && post.location_name && typeof post.latitude === "number" && !isNaN(post.latitude) && typeof post.longitude === "number" && !isNaN(post.longitude)) {
      results.push({
        id: post.id,
        title: post.title,
...
const adminFetchCountryCoordinates_createServerFn_handler = createServerRpc({
  id: "fd6783061b98e7254f39ebe01dfafcc99df7989c00c755ec4770fab1c9cebd92",
  name: "adminFetchCountryCoordinates",
  filename: "src/lib/geocoding.functions.ts"
}, (opts) => adminFetchCountryCoordinates.__executeServer(opts));
const adminFetchCountryCoordinates = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).validator((i) => objectType({
  country: stringType().trim().min(1, "Country name is required")
}).parse(i)).handler(adminFetchCountryCoordinates_createServerFn_handler, async ({
  data
}) => {
  ...
  try {
    ...
    let res = await fetch(`https://nominatim.openstreetmap.org/search?${structuredParams.toString()}`, {
      headers: {
        "User-Agent": "NDSoloTravelKnowledgeHub/2.0 (contact@ndsolotravel.com)"
      }
    });
    ...
    if (!results || results.length === 0) {
      try {
        const photonRes = await fetch(`https://photon.komoot.io/api/?q=${encodeURIComponent(rawCountry)}&limit=1`);
        if (photonRes.ok) {
    ...
    if (results && results.length > 0) {
      ...
      if (!isNaN(lat) && !isNaN(lon)) {
        const displayName = first.display_name?.split(",")?.[0]?.trim() || first.name || rawCountry;
        return {
          success: true,
...
export {
  adminFetchCountryCoordinates_createServerFn_handler,
  batchGeocodePosts_createServerFn_handler,
  geocodeFromTitle_createServerFn_handler
};
