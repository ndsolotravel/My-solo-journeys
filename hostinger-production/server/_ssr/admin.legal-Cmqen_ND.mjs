...
import { d as useServerFn, V as adminListLegalPages, W as adminUpsertLegalPage, X as DEFAULT_LEGAL_PAGES } from "./router-B6m4P0F8.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { av as Scale, z as Clock, E as Eye, w as ExternalLink, R as RotateCcw, j as LoaderCircle, ay as Save, d as Sparkles, O as Shield, aV as PenLine, ap as Image, aW as Bold, aX as Italic, aY as Heading2, aZ as Heading3, ao as List, a_ as ListOrdered, $ as Quote, a$ as Link$1, y as CircleCheck } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Legal Pages CMS" }),
