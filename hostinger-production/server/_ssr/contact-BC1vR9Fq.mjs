...
import { u as useTranslations, f as useServerFn, s as sendContact, S as SITE, e as heroQO$1 } from "./router-DTYunwUp.mjs";
import { b as useSuspenseQuery } from "../_libs/tanstack__react-query.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-COrF2Ecb.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { c as Mail, q as CircleCheck, h as LoaderCircle, m as MapPin, r as Clock, I as Instagram, Y as Youtube, T as Twitter, F as Facebook, a as Linkedin } from "../_libs/lucide-react.mjs";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-w-0 gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:contact@ndsolotravel.com", className: "block w-full text-sm sm:text-base font-medium text-secondary-foreground hover:text-brand transition-colors break-all leading-snug", children: "contact@ndsolotravel.com" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:ndsolotravel@gmail.com", className: "block w-full text-xs sm:text-sm text-secondary-foreground/75 hover:text-brand transition-colors break-all leading-snug", children: "ndsolotravel@gmail.com" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3.5", children: [
