...
import "../_libs/ws.mjs";
import { j as LoaderCircle, U as User, E as Eye, w as ExternalLink, R as RotateCcw, ay as Save, d as Sparkles, N as Compass, ae as Heart, V as Bike, _ as Mountain, $ as Quote, O as Shield, G as Globe, a0 as Layers, a1 as Flag, a as Search, a2 as Settings, ap as Image, aK as Trash2, aL as Upload, aP as Plus, n as FileText, W as Wrench } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "About Page Management" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm space-y-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: draft.about_hero_headline ?? "", onChange: (e) => updateField("about_hero_headline", e.target.value), className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm text-foreground focus:border-accent focus:outline-none font-bold" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden rounded-xl border border-border bg-zinc-950", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-black/60 flex flex-col justify-end p-4 text-white", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-base font-bold leading-tight mt-1 line-clamp-2", children: draft.about_hero_headline || ABOUT_DEFAULTS.about_hero_headline })
          ] })
        ] })
      ] }) })
    ] }),
    ...
    activeSection === "motorcycle" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/3] w-full overflow-hidden rounded-xl border border-border bg-zinc-950", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: resolveMediaUrl(draft.about_motorcycle_image || ABOUT_DEFAULTS.about_motorcycle_image), alt: "Preview", className: "h-full w-full object-cover object-[25%_center]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent p-4 flex flex-col justify-end text-white", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-base font-bold mt-1", children: draft.about_motorcycle_title || ABOUT_DEFAULTS.about_motorcycle_title })
          ] })
        ] })
      ] }) })
    ] }),
    ...
    activeSection === "philosophy" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-muted/40 p-6 border border-border/50 shadow-sm space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "text-base italic leading-relaxed text-foreground font-sans", children: [
            "“",
    ...
    activeSection === "cta" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-sm space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-2xl bg-zinc-950 border border-white/10 text-white space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-lg font-bold", children: draft.about_cta_title || ABOUT_DEFAULTS.about_cta_title }),
