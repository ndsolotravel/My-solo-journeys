...
import { d as useServerFn, I as adminListNews, J as adminUpsertNews, K as adminDeleteNews, L as adminToggleNewsField, M as slugifyNews } from "./router-B6m4P0F8.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { adminUploadImage } from "./admin.functions-CnEC2dM5.mjs";
...
import "../_libs/ws.mjs";
import { al as Radio, aP as Plus, a7 as Flame, y as CircleCheck, n as FileText, a as Search, j as LoaderCircle, v as Calendar, E as Eye, aQ as Pencil, aK as Trash2, aL as Upload, z as Clock, w as ExternalLink, aR as TriangleAlert, ap as Image, X } from "../_libs/lucide-react.mjs";
...
function NewsImagePreviewBox({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full overflow-hidden rounded-2xl border border-border bg-black/5 dark:bg-black/40 p-2 min-h-[160px] max-h-56 flex items-center justify-center group animate-in fade-in duration-200", children: [
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-background/60 backdrop-blur-xs z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin text-[#4085FF]" }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-7xl mx-auto pb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-2xl bg-brand/10 text-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "h-6 w-6 text-accent animate-pulse" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "News Management" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Manage breaking dispatches, travel alerts, and homepage news bulletins" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleOpenCreate, className: "inline-flex items-center gap-2 rounded-xl bg-brand px-5 py-2 text-xs font-semibold text-white shadow-md shadow-brand/20 hover:bg-brand/90 transition-all cursor-pointer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "New News Item" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 sm:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-xs space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider", children: "Total News" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "h-4 w-4 text-accent" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-foreground", children: metrics.total }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "All entries created" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-brand/20 bg-brand/5 p-5 shadow-xs space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-brand", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider", children: "Active Breaking" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "h-4 w-4 text-accent fill-accent/20" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-brand", children: metrics.breaking }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-brand/80", children: "Live on homepage ticker" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-5 shadow-xs space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-emerald-600 dark:text-emerald-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider", children: "Published" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-emerald-500" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-emerald-600 dark:text-emerald-400", children: metrics.published }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-emerald-600/80 dark:text-emerald-400/80", children: "Published status" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-xs space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider", children: "Drafts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-4 w-4 text-muted-foreground" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-foreground", children: metrics.drafts }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Unpublished" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex flex-wrap items-center gap-1 rounded-xl border border-border bg-background p-1 text-xs font-medium", children: [{
        id: "all",
        label: "All"
      }, {
        id: "breaking",
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setFilter(tab.id), className: `inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium capitalize transition-all cursor-pointer ${isActive ? "bg-brand text-white font-semibold shadow-2xs" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`, children: [
          Icon && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `h-3 w-3 ${isActive ? "text-white fill-white/20" : "text-accent"}` }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 sm:max-w-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search headline, summary, slug…", className: "w-full rounded-xl border border-border bg-background pl-9 pr-4 py-2 text-xs font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl border border-border bg-card shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y divide-border", children: [
        isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { colSpan: 7, className: "px-4 py-12 text-center text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin mx-auto mb-2 text-accent" }),
          "Loading news items…"
        ] }) }),
        filteredNews.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-muted/30 transition-colors group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 min-w-[240px] max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground line-clamp-1 group-hover:text-accent transition-colors", children: item.title }),
            ...
            }), title: isPublished ? "Click to set Draft" : "Click to Publish", className: "inline-block transition-transform hover:scale-105 cursor-pointer", children: isPublished ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-emerald-500/10 px-2.5 py-1 text-xs font-semibold text-emerald-600 dark:text-emerald-400 border border-emerald-500/20", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }),
              " Published"
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 rounded-full bg-muted px-2.5 py-1 text-xs font-medium text-muted-foreground border border-border/60", children: "Draft" }) }) }),
            ...
            }), title: item.is_breaking ? "Breaking News Enabled (Click to disable)" : "Standard News (Click to enable Breaking)", className: `inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-semibold transition-all hover:scale-105 cursor-pointer ${item.is_breaking ? "bg-accent/15 text-accent border border-accent/30 shadow-xs" : "bg-muted text-muted-foreground border border-border/60"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: `h-3.5 w-3.5 ${item.is_breaking ? "text-accent fill-accent/40 animate-pulse" : ""}` }),
            ...
            }), title: item.is_active ? "Active (Click to deactivate)" : "Inactive (Click to activate)", className: `inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-medium transition-all hover:scale-105 cursor-pointer ${item.is_active ? "bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20" : "bg-muted text-muted-foreground border border-border/60"}`, children: item.is_active ? "Active" : "Inactive" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3.5 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setPreviewTarget(item), title: "Preview News", className: "flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted hover:text-foreground transition-colors cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-4 w-4" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => handleOpenEdit(item), title: "Edit News", className: "flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted hover:text-accent transition-colors cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setDeleteTarget(item), title: "Delete News", className: "flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:bg-red-500/10 hover:text-red-600 transition-colors cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }) })
            ] }) })
          ] }, item.id);
        }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isFormOpen, onOpenChange: setIsFormOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-3xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 rounded-3xl border border-border bg-card shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-xl sm:text-2xl font-bold text-foreground", children: editingItem ? "Edit News Dispatch" : "Create News Dispatch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-xs text-muted-foreground mt-1", children: "Configure headline, summary, breaking status, scheduling, and expiry." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1 rounded-xl border border-border bg-background p-1 text-xs font-medium", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setEditorTab("edit"), className: `rounded-lg px-3 py-1 text-xs font-medium transition-all cursor-pointer ${editorTab === "edit" ? "bg-brand text-white font-semibold shadow-2xs" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`, children: "Editor" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setEditorTab("preview"), className: `rounded-lg px-3 py-1 text-xs font-medium transition-all cursor-pointer ${editorTab === "preview" ? "bg-brand text-white font-semibold shadow-2xs" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`, children: "Live Preview" })
        ] })
      ] }) }),
      editorTab === "edit" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", required: true, value: formData.title, onChange: (e) => handleTitleChange(e.target.value), placeholder: "e.g. Karakoram Highway reopened after seasonal pass clearance...", className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "URL Slug" }),
            ...
            }, className: "text-[11px] text-accent hover:underline font-medium cursor-pointer", children: "Reset from headline" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1.5", children: "Short Description / Summary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 2, value: formData.summary, onChange: (e) => setFormData((p) => ({
            ...p,
            summary: e.target.value
          })), placeholder: "Brief 1-2 sentence overview shown in tickers, previews, and meta summaries...", className: "w-full rounded-xl border border-border bg-background p-3 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors resize-y" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1.5", children: "Full News Content (Markdown Supported)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 6, value: formData.content, onChange: (e) => setFormData((p) => ({
            ...p,
            content: e.target.value
          })), placeholder: "Detailed news content, route updates, logistics, emergency contacts, or official advisories...", className: "w-full rounded-xl border border-border bg-background p-3 text-sm font-mono outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors resize-y" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1.5", children: "Featured Image (Optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-2 mb-3", children: [
            ...
            })), placeholder: "Enter image URL (https://...) or upload below", className: "flex-1 rounded-xl border border-border bg-background px-3.5 py-2 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", disabled: uploadingImage, onClick: () => fileInputRef.current?.click(), className: "inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-muted px-4 py-2 text-xs font-semibold text-foreground hover:bg-muted/80 transition-colors disabled:opacity-50 shadow-2xs cursor-pointer", children: uploadingImage ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 rounded-2xl border border-border bg-card shadow-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            })), className: "w-full rounded-xl border border-border bg-background px-3 py-2 text-sm font-medium outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1.5", children: "Breaking News" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setFormData((p) => ({
              ...p,
              is_breaking: !p.is_breaking
            })), className: `w-full flex items-center justify-between rounded-xl border px-3 py-2 text-sm font-medium transition-colors cursor-pointer ${formData.is_breaking ? "border-accent bg-accent/10 text-accent font-semibold" : "border-border bg-background text-muted-foreground hover:bg-muted"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: `h-4 w-4 ${formData.is_breaking ? "text-accent fill-accent/40" : ""}` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formData.is_breaking ? "Yes (Breaking)" : "No" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `h-2 w-2 rounded-full ${formData.is_breaking ? "bg-accent" : "bg-muted-foreground"}` })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1.5", children: "Active" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setFormData((p) => ({
              ...p,
              is_active: !p.is_active
            })), className: `w-full flex items-center justify-between rounded-xl border px-3 py-2 text-sm font-medium transition-colors cursor-pointer ${formData.is_active ? "border-blue-500/30 bg-blue-500/10 text-blue-600 dark:text-blue-400 font-semibold" : "border-border bg-background text-muted-foreground hover:bg-muted"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1.5", children: "Publication Date & Time" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Expiry Date & Time (Optional)" }),
              formData.expires_at && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setFormData((p) => ({
                ...p,
                expires_at: ""
              })), className: "text-[11px] text-red-500 hover:underline cursor-pointer", children: "Clear Expiry" })
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky bottom-0 z-10 flex items-center justify-end gap-3 pt-3 pb-3 px-6 sm:px-8 -mx-6 sm:-mx-8 -mb-6 sm:-mb-8 border-t border-border bg-card/95 backdrop-blur-md shadow-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", disabled: upsertMutation.isPending, onClick: () => setIsFormOpen(false), className: "rounded-xl border border-border bg-card px-4 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors cursor-pointer disabled:opacity-50", children: "Cancel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: upsertMutation.isPending, className: "inline-flex items-center gap-2 rounded-xl bg-brand px-5 py-2 text-xs font-semibold text-white shadow-md shadow-brand/20 hover:bg-brand/90 transition-all disabled:opacity-50 cursor-pointer", children: upsertMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-muted/10 p-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ticker-container relative flex h-10 sm:h-11 w-full items-center overflow-hidden rounded-xl border border-red-500/30 bg-black/80 backdrop-blur-xl shadow-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 flex shrink-0 items-center gap-2 bg-gradient-to-r from-red-600 via-red-600 to-red-700 px-3 sm:px-4 py-1.5 text-[11px] font-bold tracking-wider text-white uppercase shadow-md rounded-l-[11px]", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex-1 overflow-hidden h-full flex items-center select-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-ticker flex items-center shrink-0", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs sm:text-sm font-medium text-neutral-100 tracking-normal", children: formData.title || "Headline preview appears here..." }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mx-5 inline-flex items-center gap-1 text-red-500/80 font-bold select-none opacity-80", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[#4085FF] animate-pulse" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-background p-6 shadow-sm space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-[#4085FF]/10 px-2.5 py-0.5 font-bold text-[#4085FF]", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold leading-tight", children: formData.title || "Untitled Headline" }),
            formData.summary && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground leading-relaxed italic border-l-2 border-[#4085FF] pl-3", children: formData.summary }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setEditorTab("edit"), className: "rounded-xl border border-border bg-card px-5 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors cursor-pointer shadow-2xs", children: "Back to Editor" }) })
        ] })
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!previewTarget, onOpenChange: (open) => !open && setPreviewTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-2xl max-h-[85vh] overflow-y-auto p-6 sm:p-8 rounded-3xl border border-border bg-card shadow-2xl", children: previewTarget && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-accent/15 px-2.5 py-0.5 font-bold text-accent", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "h-3.5 w-3.5 fill-accent/30" }),
          " DISPATCH"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "·" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold leading-tight text-foreground", children: previewTarget.title }),
      previewTarget.summary && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed italic border-l-2 border-accent pl-3", children: previewTarget.summary }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-6 border-t border-border text-xs text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          }, target: "_blank", className: "inline-flex items-center gap-1 rounded-xl border border-border bg-card px-3.5 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors shadow-2xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Open Public Page" }),
            " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => {
            ...
            handleOpenEdit(item);
          }, className: "inline-flex items-center gap-1 rounded-xl bg-brand px-4 py-2 text-xs font-semibold text-white shadow-md shadow-brand/20 hover:bg-brand/90 transition-all cursor-pointer", children: "Edit Item" })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTarget, onOpenChange: (open) => !open && !deleteMutation.isPending && setDeleteTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "rounded-3xl border border-border bg-card shadow-2xl p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "text-lg font-bold text-foreground", children: "Delete news dispatch?" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { className: "mt-4 flex items-center justify-end gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { disabled: deleteMutation.isPending, className: "rounded-xl border border-border bg-card px-4 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors cursor-pointer", children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { className: "rounded-xl bg-red-600 px-4 py-2 text-xs font-semibold text-white shadow-md hover:bg-red-700 disabled:opacity-50 transition-all cursor-pointer inline-flex items-center gap-2", disabled: deleteMutation.isPending, onClick: (e) => {
          e.preventDefault();
