...
import { u as useTranslations, b as Route$f, c as blogQO, e as authorNameQO$1, C as CATEGORIES, d as destQO } from "./router-C1QTtW_a.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { a as useSuspenseQuery, b as useQuery } from "../_libs/tanstack__react-query.mjs";
import { P as PostCard } from "./PostCard-BYJ8SHAz.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { v as Sparkles, f as MapPin, k as Clock, p as ArrowRight, S as Search, w as SlidersHorizontal } from "../_libs/lucide-react.mjs";
...
import "node:stream";
import "./admin.functions-C2WAczeU.mjs";
...
function BlogIndex() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8", children: [
      featuredPost && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-accent", children: t("Featured Dispatch") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: {
          slug: featuredPost.slug
        }, className: "group grid gap-8 overflow-hidden rounded-3xl border border-border bg-card p-4 sm:p-8 transition-all duration-300 hover:border-accent/40 hover:shadow-xl lg:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] overflow-hidden rounded-2xl bg-muted", children: [
            ...
            featuredPost.destinations?.title && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-4 left-4 inline-flex items-center gap-1 rounded-full bg-black/70 px-3 py-1 text-xs font-medium text-amber-300 backdrop-blur-md", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3" }),
              " ",
              t(featuredPost.destinations.title)
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-xs font-medium text-accent", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "uppercase tracking-wider", children: t(featuredPost.category) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 font-display text-3xl font-bold leading-snug sm:text-4xl group-hover:text-accent transition-colors", children: t(featuredPost.title) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 space-y-6 rounded-2xl border border-border bg-card p-5 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 border-t border-border/60 pt-4", children: [
          ...
          CATEGORIES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog", search: (prev) => ({
            ...prev,
            category: c
