...
import { d as useServerFn, _ as adminListPhotoArchiveEditor, $ as adminSavePhotoArchive } from "./router-B6m4P0F8.mjs";
...
import { H as HeroBannerManager } from "./HeroBannerManager-4b5X8QDh.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { ap as Image, R as RotateCcw, j as LoaderCircle, ay as Save, y as CircleCheck, aL as Upload, a0 as Layers, d as Sparkles, aR as TriangleAlert, a as Search, b6 as FileImage, aP as Plus, b7 as EyeOff, t as Maximize2, aQ as Pencil, x as ChevronLeft, p as ChevronRight, aK as Trash2, o as MapPin, X, v as Calendar, r as Camera } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-7xl mx-auto pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-30 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Photography Archive" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-3xl font-bold", children: isLoading ? "—" : (drafts?.length ?? 0).toLocaleString() }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-3xl font-bold", children: categories.length }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 shadow-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-3xl font-bold", children: pendingNewCount + draftCount + deletedIds.length }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 sm:w-64", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search captions, locations…", className: "w-full rounded-xl border border-border bg-background pl-9 pr-4 py-2 text-xs outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 border-b border-border/60 pb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-base font-semibold flex items-center gap-2 text-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Uploads are staged as drafts — every photograph needs a caption and alt text before it can be published." })
        ] }),
      ...
      displayed.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3.5", children: displayed.map((item, idx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `group relative flex flex-col justify-between overflow-hidden rounded-xl border bg-card transition-all select-none shadow-xs ${incomplete ? "border-amber-400 ring-2 ring-amber-400/30" : "border-border hover:border-accent/60 hover:shadow-md"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-4/3 w-full bg-muted/40 overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute left-2 top-2 z-10 flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded-md bg-black/75 px-2 py-0.5 text-[10px] font-bold text-white shadow-xs backdrop-blur-xs", children: [
                "#",
                item.sort_order + 1
              ] }),
              item.source_type === "story" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-md bg-sky-600/90 px-1.5 py-0.5 text-[9px] font-semibold text-white shadow-xs backdrop-blur-xs", children: "Story" }),
              item.source_type === "destination" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-md bg-emerald-600/90 px-1.5 py-0.5 text-[9px] font-semibold text-white shadow-xs backdrop-blur-xs", children: "Destination" })
            ] }),
            ...
            incomplete && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 left-1/2 z-10 -translate-x-1/2 whitespace-nowrap rounded-md bg-amber-500/95 px-2 py-0.5 text-[10px] font-bold text-white shadow-xs backdrop-blur-xs", children: "Needs caption & alt text" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-card border-t border-border space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-foreground truncate", title: item.title, children: item.title || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-muted-foreground", children: "Untitled caption" }) }),
            item.location && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1 text-[10px] text-muted-foreground truncate", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTargetId, onOpenChange: (open) => !open && setDeleteTargetId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "rounded-3xl border border-border bg-card shadow-2xl p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "text-lg font-bold text-foreground", children: "Remove photograph from the archive?" }),
    ...
    editing && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-black/60 p-3 sm:p-6 backdrop-blur-sm overflow-y-auto", onClick: closeEditor, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-4xl rounded-3xl border border-border bg-card shadow-2xl overflow-hidden", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 border-b border-border px-6 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: editing.id.startsWith("new-") ? "New Photograph" : "Photograph Details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Update photo, caption, location, category, alt text, and display settings." })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 p-6 sm:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          editing.source_type === "story" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-sky-500/20 bg-sky-500/10 p-3 text-xs text-sky-700 dark:text-sky-300 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4 shrink-0 text-sky-500" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Synchronized with ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Blog Story" }),
              " cover picture. Custom gallery caption, categories, and alt text can still be customized below."
            ] })
          ] }),
          editing.source_type === "destination" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-3 text-xs text-emerald-700 dark:text-emerald-300 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 shrink-0 text-emerald-500" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Synchronized with ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Destination" }),
              " featured picture. Custom gallery caption, categories, and alt text can still be customized below."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "mb-1.5 flex items-center gap-1.5 text-xs font-medium text-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-3.5 w-3.5 text-accent" }),
              " Photograph Image"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "url", value: editing.image_url, onChange: (e) => updateEdit({
                image_url: e.target.value
              }), placeholder: "Image URL (https://...)", className: "flex-1 rounded-xl border border-border bg-background px-3 py-2 text-xs outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex items-center gap-1.5 rounded-xl border border-border bg-card px-3 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors cursor-pointer shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-3.5 w-3.5 text-accent" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 pt-2 border-t border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1.5 block text-xs font-medium text-foreground", children: "Display order" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", min: 0, value: editing.sort_order, onChange: (e) => updateEdit({
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex items-center gap-2.5 cursor-pointer text-sm font-medium text-foreground py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: editing.published, onChange: (e) => updateEdit({
                published: e.target.checked
              }), className: "h-4 w-4 rounded border-border text-accent focus:ring-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Published / Active" })
            ] }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 4, value: editing.title, onChange: (e) => updateEdit({
              title: e.target.value
            }), placeholder: "e.g. Solo journey across the high-altitude Karakoram Highway", className: `w-full rounded-xl border bg-background p-3 text-sm outline-none transition-colors resize-y leading-relaxed ${!editing.title.trim() ? "border-amber-400 focus:border-amber-400 focus:ring-1 focus:ring-amber-400" : "border-border focus:border-accent focus:ring-1 focus:ring-accent"}` }),
            !editing.title.trim() && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] text-amber-600", children: "Description / caption is required." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            }), placeholder: "e.g. Karakoram Highway, Gilgit-Baltistan", className: "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-sm outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "mb-1.5 block text-xs font-medium text-foreground", children: [
              "Alt text ",
      ...
      editingPreviewInvalid && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-6 mb-4 flex items-center gap-2 rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-2.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-amber-700", children: "This photograph is incomplete — save will be blocked until caption and alt text are filled in." })
      ] }),
