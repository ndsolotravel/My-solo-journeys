...
import { u as useTranslations, L as popularQO, M as guidesQO, N as NewsletterForm, I as postsQO, J as featuredQO, K as destQO$2, O as galleryQO, P as motoQO, Q as hitStatsQO, a as useServerFn, G as pingVisitor, H as getLiveVisitorCount } from "./router-n4Spr6qJ.mjs";
...
import "../_libs/ws.mjs";
import { E as Earth, B as Bike, m as Camera, R as Route, n as Calendar, S as Search, o as ArrowRight, p as Compass, q as Mountain, f as MapPin, r as Eye, s as Users, t as BookOpen, u as Activity, v as Map, g as ChevronLeft, h as ChevronRight } from "../_libs/lucide-react.mjs";
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "hit-counter", "aria-labelledby": "hit-counter-heading", className: "border-b border-border bg-slate-100/90 dark:bg-muted/30 py-16 sm:py-20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group rounded-2xl border border-border/80 bg-background p-5 shadow-sm transition-all duration-300 hover:border-accent/40 hover:shadow-md", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 font-display text-3xl font-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { end: hit.totalPageHits, suffix: "+" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-[11px] text-muted-foreground", children: [
            "+",
            hit.weeklyPageHits.toLocaleString(),
            " ",
            t("page views this week")
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group rounded-2xl border border-border/80 bg-background p-5 shadow-sm transition-all duration-300 hover:border-accent/40 hover:shadow-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 font-display text-3xl font-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { end: hit.uniqueReaders, suffix: "+" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-[11px] text-muted-foreground", children: [
            t("Across"),
            " ",
            hit.countries.toLocaleString(),
            " ",
            t("countries")
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group rounded-2xl border border-border/80 bg-background p-5 shadow-sm transition-all duration-300 hover:border-accent/40 hover:shadow-md", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 font-display text-3xl font-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { end: hit.storiesRead, suffix: "+" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-[11px] text-muted-foreground", children: [
            t("Avg. reading time"),
            ": ",
            hit.avgReadingMinutes,
            " ",
            t("min")
          ] })
        ] }),
