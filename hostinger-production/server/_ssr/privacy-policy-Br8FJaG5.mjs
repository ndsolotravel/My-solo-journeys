...
import { u as useTranslations, R as Route$A } from "./router-C1RUja_2.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-C7VLGZZS.mjs";
...
function PrivacyPolicyPage() {
  ...
  const heroImage = legalPage?.hero_image || "https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?w=2000&q=80";
  const content = legalPage?.content || "";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[30vh] min-h-[220px] w-full overflow-hidden flex flex-col justify-center items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImage, alt: title, className: "absolute inset-0 h-full w-full object-cover" }),
