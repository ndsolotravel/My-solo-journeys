...
import { d as useServerFn, C as CATEGORIES } from "./router-B6m4P0F8.mjs";
import { f as useNavigate } from "../_libs/tanstack__react-router.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { adminUpsertPost, adminUploadImage, adminDeleteGalleryImage, adminSavePostGallery, adminListDestinations, adminDetectDestination, adminUpdatePostCoordinates } from "./admin.functions-CnEC2dM5.mjs";
import { r as resolveMediaUrl } from "./media-5OPpyOwL.mjs";
import { a as adminListCategories } from "./categories.functions-BG32lH_N.mjs";
import { geocodeFromTitle } from "./geocoding.functions-C-OZdE3U.mjs";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-AVgfhTyo.mjs";
import { ap as Image, j as LoaderCircle, aL as Upload, b6 as FileImage, bc as GripVertical, t as Maximize2, x as ChevronLeft, p as ChevronRight, aK as Trash2, X, G as Globe, y as CircleCheck, k as CircleAlert, aR as TriangleAlert, a as Search, aA as Monitor, aC as Smartphone, K as KeyRound, am as Tag, U as User, o as MapPin, ad as Navigation, aJ as CircleX, v as Calendar, N as Compass, d as Sparkles, w as ExternalLink, ay as Save, ac as BookOpen, aW as Bold, aX as Italic, aY as Heading2, ao as List, a$ as Link, aV as PenLine, E as Eye, ak as ChevronDown } from "../_libs/lucide-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          mode !== "write" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[480px] max-h-[800px] overflow-y-auto border-l border-border p-4 prose-blog text-sm", children: value.trim() ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Markdown,
            {
              rehypePlugins: [rehypeRaw],
              components: {
                figure: ({ children, node, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx("figure", { className: "my-6 w-full text-center", ...props, children }),
                figcaption: ({ children, node, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx("figcaption", { className: "mt-2 text-center text-xs text-muted-foreground italic font-sans", ...props, children }),
                img: ({ src, alt, node, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Preview will appear here…" }) })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1 truncate text-lg font-semibold", children: title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
...
function getMetaDescriptionSeo(text) {
  const len = text.trim().length;
  if (len === 0) {
    return {
      status: "Needs Improvement",
...
function PostEditor({
  ...
  const [destinationMode, setDestinationMode] = reactExports.useState("auto");
  const [destinationId, setDestinationId] = reactExports.useState(initial?.destination_id ?? "");
  const [detectedDest, setDetectedDest] = reactExports.useState(null);
  const [isDetectingDest, setIsDetectingDest] = reactExports.useState(false);
  ...
  const [primaryKeyword, setPrimaryKeyword] = reactExports.useState(initial?.primary_keyword ?? "");
  const [secondaryKeywords, setSecondaryKeywords] = reactExports.useState(initial?.secondary_keywords ?? "");
      ...
      try {
        const res = await detectDestFn({
          data: {
            ...
            content: content.slice(0, 1e3) || null,
  ...
  const body = /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: formId, onSubmit: submit, className: "grid gap-6 lg:grid-cols-[1fr_340px] pb-28 sm:pb-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      ...
      (() => {
        ...
        const overallSeoStatus = titleHealth.status === "Good" && descHealth.status === "Good" ? { label: "Good", badge: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/30" } : titleHealth.status === "Too Long" || descHealth.status === "Too Long" ? { label: "Too Long", badge: "bg-rose-500/10 text-rose-600 dark:text-rose-400 border-rose-500/30" } : { label: "Needs Improvement", badge: "bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/30" };
        const effectivePreviewTitle = seoTitle.trim() || (title.trim() ? `${title.trim()} — ndsolotravel` : "Your Story Title — ndsolotravel");
        const effectivePreviewSlug = slug.trim() || (title.trim() ? title.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "") : "story-slug");
        const effectivePreviewDesc = seoDescription.trim() || excerpt.trim() || "Add a compelling meta description to increase click-through rates from search engine results.";
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 sm:p-6 space-y-6 shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 border-b border-border/70 pb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-base sm:text-lg font-semibold flex items-center gap-2 text-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "h-5 w-5 text-accent" }),
                  " SEO & Search Engine Optimization"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-accent/10 px-2.5 py-0.5 text-xs font-semibold text-accent border border-accent/20", children: "Google SERP" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Manage search engine indexing, snippet appearance, and keyword relevance for this individual story." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium border bg-muted/30", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-[11px]", children: "Overall SEO:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold border ${overallSeoStatus.badge}`, children: [
                overallSeoStatus.label === "Good" && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }),
                overallSeoStatus.label === "Needs Improvement" && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
                overallSeoStatus.label === "Too Long" && /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3 w-3" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-xs font-semibold uppercase tracking-wider text-foreground flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Meta Title" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-normal text-muted-foreground lowercase", children: "(Google page title)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    className: `text-xs font-mono font-medium ${seoTitle.length > 60 ? "text-rose-500 font-semibold" : seoTitle.length >= 30 ? "text-emerald-500 font-semibold" : "text-amber-500"}`,
                    children: [
                      seoTitle.length,
                      " / 60 characters"
                    ]
                ...
                titleHealth.status === "Good" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 px-2.5 py-0.5 text-[11px] font-semibold text-emerald-600 dark:text-emerald-400", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }),
                  "Good"
                ] }),
                titleHealth.status === "Needs Improvement" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-amber-500/10 border border-amber-500/30 px-2.5 py-0.5 text-[11px] font-semibold text-amber-600 dark:text-amber-400", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
                  "Needs Improvement"
                ] }),
                titleHealth.status === "Too Long" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-rose-500/10 border border-rose-500/30 px-2.5 py-0.5 text-[11px] font-semibold text-rose-600 dark:text-rose-400", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px] text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: titleHealth.message }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/80", children: "Optimal: 30–60 characters" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-xs font-semibold uppercase tracking-wider text-foreground flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Meta Description" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-normal text-muted-foreground lowercase", children: "(search result snippet)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    className: `text-xs font-mono font-medium ${seoDescription.length > 160 ? "text-rose-500 font-semibold" : seoDescription.length >= 70 ? "text-emerald-500 font-semibold" : "text-amber-500"}`,
                    children: [
                ...
                descHealth.status === "Good" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 px-2.5 py-0.5 text-[11px] font-semibold text-emerald-600 dark:text-emerald-400", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }),
                  "Good"
                ] }),
                descHealth.status === "Needs Improvement" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-amber-500/10 border border-amber-500/30 px-2.5 py-0.5 text-[11px] font-semibold text-amber-600 dark:text-amber-400", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
                  "Needs Improvement"
                ] }),
                descHealth.status === "Too Long" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-rose-500/10 border border-rose-500/30 px-2.5 py-0.5 text-[11px] font-semibold text-rose-600 dark:text-rose-400", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3 w-3" }),
                  "Too Long"
                ] })
              ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px] text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: descHealth.message }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/80", children: "Optimal: 70–160 characters" })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/80 bg-muted/20 p-4 sm:p-5 space-y-3.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 border-b border-border/60 pb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-4 w-4 text-[#4285F4]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider text-foreground", children: "SEO Preview (Google Search Result)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 bg-background border border-border rounded-lg p-0.5 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    onClick: () => setPreviewDevice("desktop"),
                    className: `inline-flex items-center gap-1 px-2.5 py-1 rounded-md transition-colors cursor-pointer ${previewDevice === "desktop" ? "bg-muted text-foreground font-semibold shadow-xs" : "text-muted-foreground hover:text-foreground"}`,
                    children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `inline-flex items-center gap-1 px-2.5 py-1 rounded-md transition-colors cursor-pointer ${previewDevice === "mobile" ? "bg-muted text-foreground font-semibold shadow-xs" : "text-muted-foreground hover:text-foreground"}`,
                    children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `rounded-xl border border-border/60 bg-white dark:bg-[#202124] p-4 transition-all shadow-xs ${previewDevice === "mobile" ? "max-w-md mx-auto" : "w-full"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-[#303134] border border-border/50 text-[10px] font-bold text-[#4085FF]", children: "ND" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1 leading-tight", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] font-medium text-[#202124] dark:text-[#dadce0] truncate", children: "ndsolotravel.com" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-[#4d5156] dark:text-[#bdc1c6] truncate", children: [
                        "https://ndsolotravel.com › blog › ",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h4",
                    {
                      className: `font-normal text-[#1a0dab] dark:text-[#8ab4f8] hover:underline cursor-pointer line-clamp-2 leading-snug ${previewDevice === "mobile" ? "text-[16px]" : "text-[19px]"}`,
                      children: effectivePreviewTitle
                    }
                  ) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-[#006621] dark:text-[#8ab4f8]/80 font-mono mt-0.5 truncate", children: [
                    "/blog/",
                    effectivePreviewSlug
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `mt-1.5 text-[#4d5156] dark:text-[#bdc1c6] line-clamp-3 leading-relaxed ${previewDevice === "mobile" ? "text-[12px]" : "text-[13px]"}`,
                      children: effectivePreviewDesc
                    }
                  )
                ]
              }
            ),
            primaryKeyword.trim() ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border/50 flex flex-wrap items-center gap-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground font-medium flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(KeyRound, { className: "h-3.5 w-3.5 text-accent" }),
                "Primary Keyword: ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium border ${kwInTitle ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/30" : "bg-muted text-muted-foreground border-border"}`,
                  children: [
                    kwInTitle ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
                    "In Title: ",
                    kwInTitle ? "Yes" : "No"
                  ]
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium border ${kwInSlug ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/30" : "bg-muted text-muted-foreground border-border"}`,
                  children: [
                    kwInSlug ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
                    "In Slug: ",
                    kwInSlug ? "Yes" : "No"
                  ]
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: `inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium border ${kwInDesc ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/30" : "bg-muted text-muted-foreground border-border"}`,
                  children: [
                    kwInDesc ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" }),
                    "In Description: ",
                    kwInDesc ? "Yes" : "No"
                  ]
                }
              )
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground pt-1 flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-5 space-y-4 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-2 border-t border-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-xs font-semibold uppercase tracking-wider text-foreground flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Compass, { className: "h-3.5 w-3.5 text-sky-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Destination Connection" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex rounded-lg border border-border bg-background p-0.5 text-[11px] font-medium shadow-2xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => setDestinationMode("auto"),
                  className: `px-2.5 py-1 rounded-md transition-all flex items-center gap-1 cursor-pointer ${destinationMode === "auto" ? "bg-accent text-accent-foreground font-semibold shadow-xs" : "text-muted-foreground hover:text-foreground"}`,
                  children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `px-2.5 py-1 rounded-md transition-all flex items-center gap-1 cursor-pointer ${destinationMode === "manual" ? "bg-accent text-accent-foreground font-semibold shadow-xs" : "text-muted-foreground hover:text-foreground"}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Manual" })
                }
              )
            ] })
          ] }),
          destinationMode === "auto" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            isDetectingDest ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-xl border border-sky-500/20 bg-sky-500/5 p-3 text-xs text-sky-600 dark:text-sky-400 animate-pulse", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Analyzing location and detecting destination..." })
            ] }) : detectedDest?.status === "existing_found" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3 space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs font-semibold text-emerald-700 dark:text-emerald-400", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Existing destination found:" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-foreground pl-5.5", children: [
                detectedDest.name,
                " ",
                detectedDest.country && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-normal text-muted-foreground", children: [
                  "(",
                  detectedDest.country,
                  ")"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground pl-5.5", children: "Will automatically attach this blog using verified database ID." })
            ] }) : detectedDest?.status === "new_created" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-sky-500/30 bg-sky-500/10 p-3 space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs font-semibold text-sky-700 dark:text-sky-400", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4 shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "New destination will be created:" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-foreground pl-5.5", children: [
                detectedDest.name,
                " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground pl-5.5", children: "Auto-populating name, unique slug, coordinates, description, and blog cover image upon save." })
            ] }) : (destinations ?? []).find((d) => d.id === destinationId) ? (() => {
              const linked = (destinations ?? []).find((d) => d.id === destinationId);
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3 space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs font-semibold text-emerald-700 dark:text-emerald-400", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Destination attached:" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-foreground pl-5.5", children: [
                  linked?.title,
                  " ",
                  linked?.country && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-normal text-muted-foreground", children: [
                    "(",
                    linked.country,
                    ")"
                  ] })
            ...
            })() : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-muted/30 p-3 text-xs text-muted-foreground flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Compass, { className: "h-4 w-4 text-muted-foreground shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Destination will be auto-determined using Location, Coordinates, Country, or Title on save." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px] text-muted-foreground pt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Priority: Location > Coords > Country > Title" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            (() => {
              ...
              const locHasSeychelles = loc.includes("seychelles") || loc.includes("mahe") || loc.includes("praslin") || loc.includes("la digue");
              const locHasPakistan = loc.includes("pakistan") || loc.includes("hunza") || loc.includes("skardu") || loc.includes("karakoram");
              const conflict = isPakistanDest && locHasSeychelles || isSeychellesDest && locHasPakistan;
              if (conflict) {
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-rose-500/30 bg-rose-500/10 p-2.5 text-xs text-rose-600 dark:text-rose-400 flex items-start gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 shrink-0 mt-0.5" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Country Mismatch Warning:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] mt-0.5 text-foreground", children: [
                      'Destination "',
                      selectedDest.title,
                      '" is in ',
                      selectedDest.country,
                      ", but this story location mentions ",
                      locationName,
                      ". Please select a destination in the correct country."
                    ] })
                  ] })
                ] });
              }
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1.5 text-xs text-emerald-600 dark:text-emerald-400 font-medium pl-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      initial?.slug && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3 text-[#4085FF]" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `inline-flex items-center gap-2 rounded-xl px-5 py-2 text-xs sm:text-sm font-semibold transition-all ${!isDirty || save.isPending ? "opacity-50 cursor-not-allowed bg-[#4085FF]/70 text-white" : "bg-[#4085FF] text-white shadow-md shadow-[#4085FF]/25 hover:bg-[#4085FF]/90 cursor-pointer"}`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 relative max-w-7xl mx-auto pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-2xl bg-[#4085FF]/10 text-[#4085FF]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-6 w-6" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl sm:text-3xl font-bold tracking-tight text-foreground", children: initial?.id ? "Edit Story" : "New Solo Story" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 z-50 w-full border-t border-border bg-card/95 backdrop-blur-md px-4 sm:px-6 py-3.5 shadow-[0_-4px_24px_rgba(0,0,0,0.08)] transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:block min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-xs font-bold text-foreground max-w-[200px] lg:max-w-xs", children: title || "Untitled Story" }),
        ...
        saveStatus === "idle" && isDirty && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:inline-flex items-center gap-1.5 rounded-full bg-[#4085FF]/10 border border-[#4085FF]/25 px-3 py-1 text-xs font-semibold text-[#4085FF] animate-fade-in", children: [
...
const input = "w-full rounded-xl border border-border bg-background px-3.5 py-2.5 text-xs sm:text-sm text-foreground outline-none focus:border-[#4085FF] focus:ring-1 focus:ring-[#4085FF] transition-colors shadow-2xs";
function Field({
  label,
  hint,
  children
