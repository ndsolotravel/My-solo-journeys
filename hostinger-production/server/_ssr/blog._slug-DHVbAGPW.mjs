...
import { O as Route$h, P as authorNameQO, i as useLanguage, u as useTranslations, Q as NewsletterForm, a as useServerFn } from "./router-D9Nbuboh.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { a as useQuery, u as useQueryClient, c as useMutation } from "../_libs/tanstack__react-query.mjs";
import { v as createSsrRpc } from "./admin.functions-DGJYtjjS.mjs";
import { c as createServerFn } from "./server-7Z2Wk8DL.mjs";
import { P as PostCard } from "./PostCard-CqXCb3se.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-DyVuLgC_.mjs";
import "../_libs/ws.mjs";
import "../_libs/seroval.mjs";
import { l as MapPin, U as User, v as Calendar, p as Clock, _ as List, $ as Image, X, m as ChevronLeft, n as ChevronRight, r as ArrowLeft, f as ArrowRight, a0 as Navigation, z as Check, D as Share2, a1 as Star } from "../_libs/lucide-react.mjs";
...
function AuthorProfile({
  ...
  const isHussain = profile?.username && profile.username.trim().toLowerCase() === "hussain" || authorName.trim().toLowerCase() === "hussain";
...
function PostPage() {
  const loaderData = Route$h.useLoaderData();
  const {
    post,
    related
  } = loaderData;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "pb-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[60vh] min-h-[420px] w-full overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 mx-auto max-w-3xl px-4 pb-12 text-white sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
          ...
          post.location_name ? dest?.slug ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/destinations/$slug", params: {
            slug: dest.slug
            ...
            " ",
            post.location_name
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-accent/20 backdrop-blur-md px-3 py-1 text-xs font-medium text-amber-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3" }),
            " ",
            post.location_name
          ] }) : dest?.slug ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/destinations/$slug", params: {
            slug: dest.slug
          }, className: "inline-flex items-center gap-1 rounded-full bg-accent/20 backdrop-blur-md px-3 py-1 text-xs font-medium text-amber-300 hover:bg-accent/30 transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3" }),
            " ",
            t(dest.title)
          ] }) : dest?.title ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-accent/20 backdrop-blur-md px-3 py-1 text-xs font-medium text-amber-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3" }),
            " ",
            t(dest.title)
          ] }) : null
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-12 max-w-3xl px-4 sm:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AuthorProfile, { authorName: postAuthor, postTitle: localizedPost.title }),
