...
import { u as useTranslations, a as useLanguage } from "./router-B5b4WQf1.mjs";
...
function TranslatedMarkdown({
  ...
  const components = reactExports.useMemo(() => {
    const baseMediaComponents = {
      figure: ({ children, node, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx("figure", { className: "my-8 w-full text-center", ...props, children }),
      figcaption: ({ children, node, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx("figcaption", { className: "mt-2.5 text-center text-sm text-muted-foreground italic font-sans", ...props, children: isDbTranslated ? children : translateMarkdownChildren(children, t) }),
