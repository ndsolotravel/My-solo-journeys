...
function AccountPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-sans mx-auto max-w-2xl px-4 py-16 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold font-sans", children: "Your account" }),
