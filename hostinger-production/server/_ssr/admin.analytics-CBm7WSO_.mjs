...
import { a as useServerFn, v as getAdminAnalyticsDetails } from "./router-n4Spr6qJ.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { a0 as RefreshCw, u as Activity, s as Users, r as Eye, n as Calendar, a1 as TrendingUp, G as Globe, e as FileText, x as ArrowUpRight, a2 as Laptop, a3 as Smartphone, a4 as Tablet, O as Share2, z as Sparkles, w as Clock } from "../_libs/lucide-react.mjs";
...
function AdminAnalyticsPage() {
  ...
  const {
    ...
    refetchInterval: 1e4
    // auto refresh live stats every 10s
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: Users, label: "Total Unique Visitors", value: data?.totalVisitors, sub: "Unique session IDs tracked", loading: isLoading }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: Calendar, label: "Today's Visitors", value: data?.todayVisitors, sub: data ? `${data.todayPageViews} views today · ${data.yesterdayVisitors} yesterday` : void 0, loading: isLoading })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-background p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between pb-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Anonymous active visitor sessions with country and device metadata." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border text-muted-foreground uppercase tracking-wider", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-3 font-semibold", children: "Session ID" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "py-8 text-center text-muted-foreground", children: "Loading recent visitor sessions..." }) }) : (data?.recentVisitors ?? []).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "py-8 text-center text-muted-foreground", children: "No active visitor sessions recorded yet." }) }) : data?.recentVisitors.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-muted/50 transition", children: [
