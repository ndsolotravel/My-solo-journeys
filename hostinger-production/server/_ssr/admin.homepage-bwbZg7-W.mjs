...
import { d as useServerFn, V as adminGetHomepageEditor, W as adminSaveHomepageSettings } from "./router-BuJVAroo.mjs";
...
import "../_libs/ws.mjs";
import { h as LoaderCircle, B as Compass, ap as Eye, E as ExternalLink, R as RotateCcw, ax as Save, b as Sparkles, o as ImagePlus, V as Layers, aP as Rocket, r as Maximize2, G as Globe, aQ as BookMarked, X, ae as Image, ay as Upload, ai as ChartColumn, $ as Earth, N as Bike, p as Camera, O as Route, t as Calendar, H as Shield, v as CircleCheck, aR as ImageOff, ar as RefreshCw, f as ArrowRight, u as ChevronLeft, n as ChevronRight, aS as Pause, aT as Play, a3 as Check, aU as Copy } from "../_libs/lucide-react.mjs";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border/70 bg-muted/20 p-4 sm:p-5 space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 w-full min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-3 sm:p-4 transition-all hover:border-accent/40 w-full min-w-0 overflow-hidden", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2.5 sm:mt-3 font-display text-lg sm:text-xl lg:text-2xl font-bold text-foreground tabular-nums whitespace-nowrap", children: draft.homepage_stat_countries_mode === "manual" ? draft.homepage_stat_countries?.trim() || "27" : computedCountries }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-3 sm:p-4 transition-all hover:border-accent/40 w-full min-w-0 overflow-hidden", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5 sm:mt-3 font-display text-lg sm:text-xl lg:text-2xl font-bold text-foreground tabular-nums whitespace-nowrap", children: [
