...
import { b as useServerFn, L as adminGetHomepageEditor, M as adminSaveHomepageSettings } from "./router-BYgHxQI4.mjs";
...
function AdminHomepagePage() {
  ...
  const heroSlots = HERO_IMAGE_FIELDS.map((field, i) => {
    ...
    return {
      ...
      defaultAlt: defaultSlide.alt,
      source: "auto-post",
      caption: cover ? post?.title ?? "Latest post" : post ? `${post.title} (no cover image — default slide used)` : "Default Unsplash Slide",
