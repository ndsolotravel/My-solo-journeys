...
import { u as useTranslator } from "./router-CX8iDSYq.mjs";
...
const ABOUT_TEXTS = ["About", "Solo, slow, and almost always uphill.", "The journey so far", "Travel philosophy", "Solo travel is where the journey becomes the destination"];
...
function AboutPage() {
  const texts = reactExports.useMemo(() => [...ABOUT_TEXTS, ...BIO, ...TIMELINE.map((t2) => t2.text)], []);
