...
import "../_libs/ws.mjs";
import { a2 as LayoutDashboard, a3 as ChartColumn, k as FileText, V as Radio, W as FolderTree, $ as Image, l as MapPin, a4 as House, a5 as Scale, a6 as MessageSquare, a7 as Users, c as Mail, d as Megaphone, a8 as Settings, L as LogOut } from "../_libs/lucide-react.mjs";
...
function AdminLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid min-h-[80vh] max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[220px_1fr] lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "md:sticky md:top-24 md:self-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-background p-3", children: [
