...
import { aa as Route$k, ab as authorNameQO, a as useLanguage, u as useTranslations, b as useContentTranslation, ac as NewsletterForm, d as useServerFn } from "./router-BuJVAroo.mjs";
...
import { P as PostCard } from "./PostCard-BydfTT4S.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-BavcMfpe.mjs";
import { r as resolveMediaUrl } from "./media-DKXRUyGU.mjs";
import "../_libs/ws.mjs";
import "../_libs/seroval.mjs";
import { U as User, t as Calendar, w as Clock, ad as List, ae as Image, X, u as ChevronLeft, n as ChevronRight, s as ArrowLeft, f as ArrowRight, m as MapPin, af as Navigation, a3 as Check, a4 as Share2, ag as Star } from "../_libs/lucide-react.mjs";
    ...
    import("../_libs/leaflet.mjs").then(function(n) {
      ...
      const popupContent = `
        <div style="font-family: Roboto, system-ui, -apple-system, sans-serif; min-width: 180px; padding: 2px;">
          ${title ? `<p style="font-family: Lora, serif; font-size: 14px; font-weight: 600; margin: 0 0 4px; color: #111; line-height: 1.25;">${title}</p>` : ""}
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose-blog mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { rehypePlugins: [rehypeRaw], components: {
          ...
          figcaption: ({
            ...
            node,
            ...props
          }) => /* @__PURE__ */ jsxRuntimeExports.jsx("figcaption", { className: "mt-2.5 text-center text-sm text-muted-foreground italic font-sans", ...props, children: translateMarkdownChildren(children, t, isDbTranslated) }),
          img: ({
            src,
            alt,
            node,
