...
import { d as useServerFn, a0 as adminGetPageHeroEditor, E as adminUpdateSetting, a1 as listDestinations, a2 as listGallery, a3 as PAGE_HERO_KEYS } from "./router-B6m4P0F8.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { adminUploadImage } from "./admin.functions-CnEC2dM5.mjs";
import { r as resolveMediaUrl } from "./media-5OPpyOwL.mjs";
import { b1 as BookMarked, d as Sparkles, j as LoaderCircle, s as ArrowDown, y as CircleCheck, aL as Upload, aD as SlidersVertical, aJ as CircleX, R as RotateCcw, ay as Save, b2 as ImageOff } from "../_libs/lucide-react.mjs";
      ...
      if (page === "gallery") {
        ...
        await updateSettingFn({
          data: {
            ...
            description: "Highlighted title text (accent color) for the gallery hero banner"
          }
        });
        await updateSettingFn({
          data: {
    ...
    !isLoaded ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-32 items-center justify-center text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin text-accent" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          effectiveImage && page === "gallery" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-lg", children: [
              draftBadge && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full border border-white/30 bg-white/10 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-white backdrop-blur-md mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-2.5 w-2.5 text-accent" }),
                draftBadge
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-base sm:text-xl md:text-2xl font-bold leading-tight text-white tracking-tight", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: draftTitle || "Moments Frozen in the Wild" }),
                " ",
                draftTitleHighlight && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: draftTitleHighlight })
              ] }),
              ...
              draftButtonText && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full bg-btn-bg px-3 py-1 text-[11px] font-semibold text-btn-text shadow-sm", children: [
                draftButtonText,
      ...
      page === "gallery" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card/60 p-4 sm:p-5 space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-xs font-medium text-foreground", children: "Title Highlight (Accent Color)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                value: draftTitleHighlight,
