...
import { ag as Route$m, ah as authorNameQO, a as useLanguage, u as useTranslations, b as useContentTranslation, ai as NewsletterForm, d as useServerFn } from "./router-B6m4P0F8.mjs";
...
import { P as PostCard } from "./PostCard-IdhLaDfY.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-FibhKiyH.mjs";
import { r as resolveMediaUrl } from "./media-5OPpyOwL.mjs";
import "../_libs/ws.mjs";
import "../_libs/seroval.mjs";
import { U as User, v as Calendar, z as Clock, ao as List, ap as Image, X, x as ChevronLeft, p as ChevronRight, u as ArrowLeft, h as ArrowRight, o as MapPin, ad as Navigation, C as Check, a4 as Share2, aq as Star } from "../_libs/lucide-react.mjs";
...
function BlogPostMap({ locationName, latitude, longitude, title }) {
  ...
  reactExports.useEffect(() => {
    ...
    import("../_libs/leaflet.mjs").then(function(n) {
      ...
      const pinIcon = L.divIcon({
        ...
        html: `
          <div style="position:relative;display:flex;align-items:center;justify-content:center;">
            <div style="position:absolute;width:24px;height:24px;border-radius:9999px;background:color-mix(in srgb, var(--accent, #4085FF) 35%, transparent);animation:ping 2s cubic-bezier(0,0,0.2,1) infinite;"></div>
            <div style="width:16px;height:16px;border-radius:9999px;background:var(--accent, #4085FF);border:2.5px solid #ffffff;box-shadow:0 2px 6px rgba(0,0,0,0.4);position:relative;z-index:2;"></div>
          </div>
        `,
        iconSize: [24, 24],
        iconAnchor: [12, 12],
      ...
      const popupContent = `
        <div style="font-family: Roboto, system-ui, -apple-system, sans-serif; min-width: 180px; padding: 2px;">
          ${title ? `<p style="font-family: Roboto, system-ui, -apple-system, sans-serif; font-size: 14px; font-weight: 600; margin: 0 0 4px; color: #111; line-height: 1.25;">${title}</p>` : ""}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-8 overflow-hidden rounded-2xl border border-border bg-card shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border bg-muted/40 px-4 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 text-[#4085FF]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: locationName || "Story Coordinates" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "h-3.5 w-3.5 text-[#4085FF]" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center sm:items-start gap-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center sm:justify-start gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-foreground", children: t(name) }),
...
function PostPage() {
  const loaderData = Route$m.useLoaderData();
  const {
    post,
    related
  } = loaderData;
  ...
  const isDbTranslated = reactExports.useMemo(() => {
    if (!post || lang === "en") return false;
    return !!post.post_translations?.find((x) => x.language_code === lang);
  }, [post, lang]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "pb-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner-hover relative h-[60vh] min-h-[420px] w-full overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 mx-auto max-w-3xl px-4 pb-12 text-white sm:px-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 font-display text-3xl font-semibold leading-tight sm:text-5xl", children: localizedPost.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-wrap items-center gap-4 text-xs text-white/80", children: [
          ...
          formattedTravelDate && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "·" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-accent", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-12 max-w-3xl px-4 sm:px-6", children: [
      localizedPost.excerpt && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body-lg leading-relaxed text-muted-foreground border-l-2 border-accent pl-4 py-1 italic", children: localizedPost.excerpt }),
      toc.length > 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { "aria-label": t("Table of Contents"), className: "my-8 rounded-2xl border border-border bg-card p-5 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm font-semibold text-foreground mb-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose-blog mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { rehypePlugins: [rehypeRaw], components: {
          h1: ({
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { id, className: "scroll-mt-24 font-display text-3xl font-semibold mt-10 mb-4 text-foreground", children: translateMarkdownChildren(children, t, isDbTranslated) });
          },
          h2: ({
            children
          }) => {
            const raw = extractText(children);
            const id = raw.toLowerCase().replace(/[^\w\s-]/g, "").replace(/\s+/g, "-");
            return /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id, className: "scroll-mt-24 font-display text-2xl font-semibold mt-10 mb-4 text-foreground", children: translateMarkdownChildren(children, t, isDbTranslated) });
          },
          h3: ({
            children
          }) => {
          ...
          p: ({
            children
          }) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-body leading-relaxed mb-5 text-foreground", children: translateMarkdownChildren(children, t, isDbTranslated) }),
          li: ({
            children
          }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-body mb-2 leading-relaxed text-foreground", children: translateMarkdownChildren(children, t, isDbTranslated) }),
          blockquote: ({
            children
          }) => /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "my-6 border-l-4 border-accent bg-muted/40 py-3.5 px-5 italic rounded-r-xl text-[1.1875rem] text-foreground shadow-sm", children: translateMarkdownChildren(children, t, isDbTranslated) }),
          figure: ({
            children,
            node,
            ...props
          }) => /* @__PURE__ */ jsxRuntimeExports.jsx("figure", { className: "my-8 w-full text-center", ...props, children }),
          figcaption: ({
            children,
            node,
            ...props
          }) => /* @__PURE__ */ jsxRuntimeExports.jsx("figcaption", { className: "mt-2.5 text-center text-sm text-muted-foreground italic font-sans leading-relaxed", children: translateMarkdownChildren(children, t, isDbTranslated) }),
          img: ({
            src,
            alt,
            node,
            ...props
          }) => /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: resolveMediaUrl(src), alt: alt && !isDbTranslated ? t(alt) : alt, referrerPolicy: "no-referrer", className: "my-6 rounded-2xl w-full max-w-full h-auto object-cover shadow-sm", loading: "lazy", ...props })
      ...
      gallery.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-14 rounded-2xl border border-border bg-card p-6 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display text-xl font-semibold flex items-center gap-2 mb-4", children: [
      ...
      (prevStory || nextStory) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 grid gap-4 sm:grid-cols-2 border-t border-border pt-8", children: [
        prevStory ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-2 text-base font-semibold text-foreground group-hover:text-accent transition-colors line-clamp-1", children: t(prevStory.title) })
        ...
        nextStory ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-2 text-base font-semibold text-foreground group-hover:text-accent transition-colors line-clamp-1", children: t(nextStory.title) })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-14 rounded-3xl border border-border bg-muted/30 p-6 sm:p-8 text-center shadow-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-semibold", children: t("Enjoyed this dispatch?") }),
    ...
    localizedRelated.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-20 max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold", children: t("Keep reading") }),
...
function CommentsSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-end justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-semibold", children: t("Reviews & Comments") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 space-y-6", children: [
      (comments ?? []).map((c, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[0.9375rem] font-medium", children: displayName }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-[0.9375rem] leading-relaxed whitespace-pre-wrap", children: c.comment })
        ] }, c.id);
      }),
