...
import { u as useTranslations, i as Route$s, j as blogQO, m as categoriesQO, C as CATEGORIES, n as authorNameQO$1, k as destQO } from "./router-B6m4P0F8.mjs";
...
import { P as PageBreadcrumbs, B as BreadcrumbJsonLd } from "./PageBreadcrumbs-FibhKiyH.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { d as Sparkles, z as Clock, o as MapPin, h as ArrowRight, a as Search, S as SlidersHorizontal } from "../_libs/lucide-react.mjs";
...
function BlogIndex() {
  ...
  const navigate = Route$s.useNavigate();
  const {
    data
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "banner-hover relative h-[45vh] min-h-[320px] w-full overflow-hidden", children: [
      featuredPost?.cover_image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: featuredPost.cover_image, alt: featuredPost.title || "Expedition trail at sunrise", className: "h-full w-full object-cover object-center" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full bg-zinc-900" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8", children: [
      ...
      featuredPost && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/blog/$slug", params: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col justify-between p-6 sm:p-8 lg:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 text-xs text-muted-foreground", children: [
            ...
            (featuredPost.location_name || featuredPost.destinations?.title) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3" }),
              " ",
              featuredPost.location_name || featuredPost.destinations?.title
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 font-display text-2xl font-bold leading-tight text-heading transition-colors group-hover:text-link-hover sm:text-3xl", children: t(featuredPost.title) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center justify-between border-t border-border/60 pt-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs font-semibold text-link transition-colors group-hover:text-link-hover group-hover:translate-x-1", children: [
              t("Read story"),
              " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 space-y-6 rounded-2xl border border-border bg-card p-5 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 pt-1", children: [
          ...
          hasActiveFilters && /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog", search: {}, className: "ml-auto text-xs text-link hover:text-link-hover hover:underline font-medium transition-colors", children: t("Clear all filters") })
        ] })
      ] }),
      gridPosts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-border bg-card p-16 text-center shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold text-heading", children: t("No expedition stories found") }),
