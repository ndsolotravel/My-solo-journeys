...
import { u as useTranslations, ab as Route$D, ac as archiveQO, ad as heroQO$2 } from "./router-B6m4P0F8.mjs";
...
import "../_libs/ws.mjs";
import { q as ImagePlus, R as RotateCcw, d as Sparkles, r as Camera, s as ArrowDown, t as Maximize2, u as ArrowLeft, h as ArrowRight, o as MapPin, v as Calendar, w as ExternalLink, D as Download, X, x as ChevronLeft, p as ChevronRight } from "../_libs/lucide-react.mjs";
...
function CinematicGalleryCarousel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-[1720px] mx-auto select-none px-2 sm:px-4 lg:px-8", children: [
    ...
    activePhoto && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 sm:mt-8 max-w-2xl mx-auto px-4 text-center transition-all duration-500 animate-fade-in", children: [
      activePhoto.location && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-accent tracking-wide mb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg sm:text-xl md:text-2xl font-semibold text-heading leading-snug tracking-tight", children: t(activePhoto.title) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex flex-wrap items-center justify-center gap-2.5 sm:gap-3 text-xs text-muted-foreground", children: [
        ...
        activePhoto.slug && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            className: "inline-flex items-center gap-1 text-[11px] font-semibold text-link hover:text-link-hover hover:underline transition-colors",
            children: [
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex w-fit items-center gap-1.5 rounded-full border border-white/30 bg-white/10 px-3 py-0.5 sm:px-3.5 sm:py-1 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.18em] text-white backdrop-blur-md shadow-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-2.5 w-2.5 sm:h-3 sm:w-3 text-accent" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-accent mt-0.5 sm:mt-1 font-bold", children: t(titleHighlight) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: "group inline-flex items-center justify-center gap-2 rounded-full bg-btn-bg text-btn-text hover:bg-btn-hover transition-all duration-200 shadow-md shadow-btn-bg/25 px-4 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-semibold cursor-pointer hover:gap-2.5 active:scale-[0.98]",
                  children: [
...
function GalleryPage() {
  ...
  const navigate = Route$D.useNavigate();
  const {
    data
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground pb-20 sm:pb-28", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mx-auto max-w-3xl px-4 pt-3 pb-1 sm:pt-4 sm:pb-2 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-heading leading-tight", children: t("My Visual Diary") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-xs sm:text-sm text-muted-foreground leading-relaxed max-w-lg mx-auto", children: [
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-body-text", children: t("adventures in photographs and high-altitude journeys") })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mt-2 sm:mt-4", children: photos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-xl px-4 py-16 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-dashed border-border bg-card p-12 sm:p-16 shadow-xs", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-heading", children: t("No photographs in this category yet") }),
