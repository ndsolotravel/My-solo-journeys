...
import { r as resolveMediaUrl, e as extractBlogMediaPath } from "./media-DKXRUyGU.mjs";
import { s as slugify } from "./categories.functions-BG32lH_N.mjs";
import "../_libs/seroval.mjs";
import "../_libs/react.mjs";
import "../_libs/ws.mjs";
import { o as objectType, s as stringType, e as enumType, b as booleanType, n as numberType, a as arrayType } from "../_libs/zod.mjs";
...
import "zlib";
import "buffer";
const DEFAULT_PHOTO_SELECT = "id,title,slug,image_url,location,captured_at,story,camera,alt_text,width,height,published,sort_order,created_at,post_id,destination_id,source_type";
...
const adminSavePhotoArchive = createServerFn({
  ...
  const {
    data: existingRows
  } = await client.from("photos").select("id,slug,image_url,post_id,destination_id,source_type");
