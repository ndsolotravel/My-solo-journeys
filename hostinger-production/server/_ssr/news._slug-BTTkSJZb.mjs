...
import { p as Route$o } from "./router-DDuYfiMI.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { s as ArrowLeft, a3 as Check, a4 as Share2, a2 as Flame, aa as Radio, t as Calendar, w as Clock, $ as Earth } from "../_libs/lucide-react.mjs";
...
function NewsDetailPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground leading-[1.15]", children: newsItem.title }),
