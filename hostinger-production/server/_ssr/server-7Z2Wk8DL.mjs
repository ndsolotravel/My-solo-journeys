...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DWDyJCsb.mjs");
...
const manifest = {
  "041edda5bad3e8b83429c688f7fbe59e6c6dbe398445ee4624099f4b361b1a74": {
    ...
    importer: () => import("./admin.functions-B46GYCIN.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BbiI8ema.mjs").then((n) => n.a0),
