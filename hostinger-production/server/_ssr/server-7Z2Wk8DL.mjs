...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D45r1YPF.mjs");
...
const manifest = {
  ...
  "2c4583f12bce21ae798f1680d431270090538471e946cd081e4b8d8460ec2b1a": {
    ...
    importer: () => import("./newsletter.functions-Cn7inhJJ.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dk8gz-sr.mjs").then((n) => n.K),
