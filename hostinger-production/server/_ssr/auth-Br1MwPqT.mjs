...
import { f as Route$x, l as logoPath } from "./router-B6m4P0F8.mjs";
import "../_libs/ws.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import { K as KeyRound, B as ShieldAlert, y as CircleCheck, u as ArrowLeft, H as Lock, J as Info } from "../_libs/lucide-react.mjs";
...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-sans mx-auto flex min-h-[80vh] max-w-md flex-col justify-center px-4 py-12 sm:px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 rounded-3xl border border-border bg-card p-8 shadow-elegant", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold font-sans", children: showReset ? "Reset Password" : isForAdmin ? "Admin Sign In" : "Sign In" }),
