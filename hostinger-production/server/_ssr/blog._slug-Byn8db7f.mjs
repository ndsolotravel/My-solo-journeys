...
import { V as Route$i, W as authorNameQO, k as useLanguage, u as useTranslations, X as NewsletterForm, b as useServerFn } from "./router-C1RUja_2.mjs";
...
import { U as User, v as Calendar, p as Clock, _ as List, $ as Image, X, n as ChevronLeft, m as ChevronRight, r as ArrowLeft, f as ArrowRight, l as MapPin, a0 as Navigation, z as Check, D as Share2, a1 as Star } from "../_libs/lucide-react.mjs";
...
function PostPage() {
  const loaderData = Route$i.useLoaderData();
  const {
    post,
    related
  } = loaderData;
