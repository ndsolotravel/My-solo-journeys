...
import { u as useTranslations, ae as destQO$1, af as heroQO } from "./router-B6m4P0F8.mjs";
...
import "../_libs/ws.mjs";
import { aj as MountainSnow, af as Earth, Z as Route, ac as BookOpen, ai as ArrowUpRight, N as Compass, ak as ChevronDown, h as ArrowRight, o as MapPin } from "../_libs/lucide-react.mjs";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: parallaxContent, className: "absolute inset-0 flex items-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "atlas-canvas pb-40 sm:pb-44", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.p,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Compass, { className: "h-3.5 w-3.5 text-[#4085FF]" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden h-px w-14 bg-gradient-to-r from-[#4085FF]/70 to-transparent sm:block" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.h1,
            {
              ...
              className: "atlas-hero-title max-w-[13ch] font-display text-[2.6rem] font-semibold leading-[0.98] tracking-tight text-white sm:text-6xl lg:text-7xl",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: [t("Solo"), t("Slow"), t("Mapped")].map((label, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-3", children: [
                i > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1 w-1 rounded-full bg-[#4085FF]/70" }),
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                d.featured && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-4 top-4 rounded-full bg-[#4085FF] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.16em] text-white shadow-lg shadow-black/20 sm:right-5 sm:top-5", children: t("Featured") }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-6 sm:p-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2.5", children: [
                    d.category && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-black/35 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#4085FF] backdrop-blur-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.p,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-px w-10 bg-[#4085FF]/70" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("dl", { className: "divide-y divide-white/10 pt-2", children: rows.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-right text-sm font-semibold text-white sm:text-[15px]", children: row.value })
                    ]
                  },
                  row.label
                )) })
...
function DestinationsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MotionConfig, { reducedMotion: "user", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "atlas-canvas relative z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-accent/10 text-accent ring-1 ring-accent/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "atlas-ledger-value font-sans tabular-nums text-2xl font-bold tracking-tight sm:text-3xl text-heading", children: stat.value }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "atlas-canvas mt-16 lg:mt-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "interactive-map", "aria-labelledby": "atlas-map-heading", className: "mt-20 scroll-mt-24", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-bold uppercase tracking-[0.26em] text-accent", children: t("The Route Atlas") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: "atlas-map-heading", className: "atlas-section-title mt-3 font-display text-4xl font-bold tracking-tight sm:text-5xl text-heading", children: t("Every place, mapped.") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid gap-8 lg:grid-cols-[1fr_22rem]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.aside, { initial: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-baseline justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold uppercase tracking-[0.24em] text-heading", children: t("Atlas Index") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground font-sans tabular-nums", children: String(destinations.length).padStart(2, "0") })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "divide-y divide-border overflow-hidden rounded-2xl border border-border", children: destinations.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/destinations/$slug", params: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "atlas-ghost atlas-ghost-dark w-8 shrink-0 font-sans tabular-nums text-lg font-bold", children: String(i + 1).padStart(2, "0") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block truncate text-sm font-semibold transition-colors text-heading group-hover:text-link-hover", children: t(d.title) }),
              ...
              d.latitude && d.longitude && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden font-sans tabular-nums text-[11px] font-medium tracking-wide text-muted-foreground/70 xl:inline-block", children: [
                Number(d.latitude).toFixed(2),
                ", ",
                Number(d.longitude).toFixed(2)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-4 w-4 shrink-0 text-muted-foreground transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-link-hover" })
            ] }) }, d.id)) })
          ] })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "chapters", "aria-labelledby": "chapters-heading", className: "mt-24 scroll-mt-24", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-bold uppercase tracking-[0.26em] text-accent", children: t("The Chapters") }),
        ...
        destinations.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold", children: t("The atlas is being compiled.") }),
