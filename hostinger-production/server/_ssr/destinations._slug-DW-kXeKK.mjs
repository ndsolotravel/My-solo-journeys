...
import { e as Route$c, u as useTranslations } from "./router-Bc_n0JF6.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { x as ArrowLeft, G as Globe, f as MapPin, o as ArrowRight } from "../_libs/lucide-react.mjs";
...
function DestinationPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[65vh] min-h-[440px] w-full overflow-hidden", children: [
      d.featured_image && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: d.featured_image, alt: d.title, className: "h-full w-full object-cover object-center" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 mx-auto max-w-7xl px-4 pb-12 text-white sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/destinations", className: "inline-flex items-center gap-1.5 text-xs text-white/80 hover:text-white transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-3.5 w-3.5 rtl:rotate-180" }),
          " ",
          t("Travel Atlas")
        ] }),
    ...
    otherDestinations.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-3", children: otherDestinations.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/destinations/$slug", params: {
        ...
        item.featured_image && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.featured_image, alt: item.title, loading: "lazy", className: "h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" }),
