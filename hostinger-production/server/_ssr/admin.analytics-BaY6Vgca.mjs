...
import { d as useServerFn, a3 as getAdminAnalyticsDetails } from "./router-CPQnAHT3.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { ar as RefreshCw, a_ as Activity, an as Users, ap as Eye, t as Calendar, a$ as TrendingUp, G as Globe, l as FileText, a5 as ArrowUpRight, b0 as Laptop, b1 as Smartphone, b2 as Tablet, a4 as Share2, b as Sparkles, v as CircleCheck, w as Clock } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-5 relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-display text-4xl font-bold text-foreground", children: isLoading ? "—" : data?.liveNow ?? 0 }),
