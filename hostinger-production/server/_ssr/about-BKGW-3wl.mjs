...
import { u as useTranslations, p as settingsQO } from "./router-C1QTtW_a.mjs";
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-4 py-16 sm:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 grid gap-12 lg:grid-cols-[5fr_7fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: portraitSrc, alt: "ndsolotravel portrait", className: "aspect-[3/4] w-full rounded-3xl object-cover" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-16 rounded-3xl bg-muted/40 p-8", children: [
