...
import { S as Search, U as User, L as LogOut, X, M as Menu, I as Instagram, Y as Youtube, T as Twitter, F as Facebook, a as Linkedin, A as ArrowUp, G as Globe, b as LoaderCircle, C as CircleAlert, c as Sun, d as Moon, e as FileText, f as MapPin } from "../_libs/lucide-react.mjs";
import { A as AnimatePresence, m as motion } from "../_libs/framer-motion.mjs";
import { o as objectType, s as stringType, e as enumType, n as numberType, b as booleanType, a as arrayType, l as literalType } from "../_libs/zod.mjs";
...
const appCss = "/assets/styles-DE7m7pOP.css";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: current.nativeName })
            ]
          }
        ),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "py-1 max-h-80 overflow-y-auto", children: LANGUAGES.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex w-full items-center justify-between px-3 py-2 text-sm hover:bg-muted ${l.code === lang ? "text-accent font-medium bg-muted/40" : "text-foreground"}`,
                  children: [
                    ...
                    l.code === lang && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded-full bg-accent" })
                  ]
                }
              ) }, l.code)) })
            ]
...
}).parse(unwrapInput$1(input))).handler(createSsrRpc("bd812cbe455e2474c467750823c0e04a2d0e066e1033c07ae27a11b9e4f23f8b"));
const getAdminAnalyticsDetails = createServerFn({
  method: "GET"
}).middleware([requireSupabaseAuth]).inputValidator((input) => objectType({
  period: enumType(["7d", "30d", "90d", "all"]).optional().default("30d")
}).parse(unwrapInput$1(input))).handler(createSsrRpc("e3b3a19a4423777ebd71a96db51fd15414149394e1f65993c32fcd8ca8649ea8"));
...
const BASE_URL = "";
const Route$o = createFileRoute("/sitemap.xml")({
  server: {
    handlers: {
      GET: async () => {
...
const $$splitComponentImporter$n = () => import("./map-BTU5dmpx.mjs");
const Route$n = createFileRoute("/map")({
  beforeLoad: () => {
    throw redirect({
      to: "/destinations",
...
const $$splitComponentImporter$m = () => import("./gallery-DM6H76os.mjs");
const Route$m = createFileRoute("/gallery")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$l = () => import("./destinations-vIosy0PX.mjs");
const Route$l = createFileRoute("/destinations")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./dashboard-BTU5dmpx.mjs");
...
const $$splitComponentImporter$j = () => import("./contact-DmYFhbZi.mjs");
...
const $$splitComponentImporter$i = () => import("./blog-9Hd3AP52.mjs");
const Route$i = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./auth-DjI3xI97.mjs");
...
const $$splitComponentImporter$g = () => import("./about-Bz5vmf8g.mjs");
...
}).parse(unwrapInput(input))).handler(createSsrRpc("520baea3e7c2272f79b5ac53e6ed105f6eccae84814ffc3a8209d4dd1e873603"));
...
const getHitCounterStats = createServerFn({
  method: "GET"
}).handler(createSsrRpc("9d766f447f59beab7bc389edb1368cf410c94a9894b90901399b613cc7e230be"));
...
const $$splitComponentImporter$e = () => import("./index-Jw43-PQt.mjs");
...
const $$splitComponentImporter$d = () => import("./destinations.index-BL0bBcC4.mjs");
const Route$d = createFileRoute("/destinations/")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$c = () => import("./blog.index-CpCBzGXq.mjs");
...
const $$splitComponentImporter$b = () => import("./destinations._slug-DVj2PXgW.mjs");
const $$splitNotFoundComponentImporter$1 = () => import("./destinations._slug-lpLyXO4I.mjs");
...
const Route$b = createFileRoute("/destinations/$slug")({
  loader: async ({
    params,
    context
  }) => {
...
const $$splitComponentImporter$a = () => import("./blog._slug-UdEirG28.mjs");
...
const Route$a = createFileRoute("/blog/$slug")({
  loader: async ({
    params,
    context
  }) => {
...
const $$splitComponentImporter$9 = () => import("./admin-pM_s9IHa.mjs");
...
const $$splitComponentImporter$8 = () => import("./account-DpSTUqQb.mjs");
const Route$8 = createFileRoute("/_authenticated/account")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./admin.index-BBFIB1r9.mjs");
const Route$7 = createFileRoute("/_authenticated/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./admin.messages-BoRSEJXN.mjs");
const Route$6 = createFileRoute("/_authenticated/admin/messages")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./admin.destinations-KkQ80FZI.mjs");
const Route$5 = createFileRoute("/_authenticated/admin/destinations")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin.comments-CA7vEqOB.mjs");
const Route$4 = createFileRoute("/_authenticated/admin/comments")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin.analytics-CBm7WSO_.mjs");
...
const $$splitComponentImporter$2 = () => import("./admin.posts.index-CQjLVXTR.mjs");
const Route$2 = createFileRoute("/_authenticated/admin/posts/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.posts.new-Cce_3Tct.mjs");
const Route$1 = createFileRoute("/_authenticated/admin/posts/new")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.posts._id-Ckwmz931.mjs");
const Route = createFileRoute("/_authenticated/admin/posts/$id")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const SitemapDotxmlRoute = Route$o.update({
  id: "/sitemap.xml",
  path: "/sitemap.xml",
  getParentRoute: () => Route$p
});
const MapRoute = Route$n.update({
  id: "/map",
  path: "/map",
  getParentRoute: () => Route$p
});
const GalleryRoute = Route$m.update({
  id: "/gallery",
  path: "/gallery",
  getParentRoute: () => Route$p
});
const DestinationsRoute = Route$l.update({
  id: "/destinations",
  path: "/destinations",
  getParentRoute: () => Route$p
});
...
const DestinationsIndexRoute = Route$d.update({
  id: "/",
  path: "/",
  getParentRoute: () => DestinationsRoute
});
const BlogIndexRoute = Route$c.update({
  id: "/",
  path: "/",
  getParentRoute: () => BlogRoute
});
const DestinationsSlugRoute = Route$b.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => DestinationsRoute
});
const BlogSlugRoute = Route$a.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => BlogRoute
});
...
const AuthenticatedAccountRoute = Route$8.update({
  id: "/account",
  path: "/account",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAdminIndexRoute = Route$7.update({
  id: "/",
  path: "/",
  getParentRoute: () => AuthenticatedAdminRoute
});
const AuthenticatedAdminMessagesRoute = Route$6.update({
  id: "/messages",
  path: "/messages",
  getParentRoute: () => AuthenticatedAdminRoute
});
...
export {
  Route$a as A,
  adminUpsertPost as B,
  CATEGORIES as C,
  adminListPosts as D,
  adminTogglePublish as E,
  adminDeletePost as F,
  pingVisitor as G,
  getLiveVisitorCount as H,
  postsQO as I,
  featuredQO as J,
  destQO$2 as K,
  popularQO as L,
  ...
  getMyRoles as g,
  adminAnalytics as h,
  adminListMessages as i,
  adminUpdateMessageStatus as j,
  adminDeleteMessage as k,
  logoPath as l,
  adminListDestinations as m,
  adminUpsertDestination as n,
  adminDeleteDestination as o,
  adminUploadImage as p,
  qo$1 as q,
  adminListComments as r,
  sendContact as s,
  adminDeleteComment as t,
  useTranslations as u,
  getAdminAnalyticsDetails as v,
  Route as w,
  adminGetPost as x,
  destQO$1 as y,
  createSsrRpc as z
