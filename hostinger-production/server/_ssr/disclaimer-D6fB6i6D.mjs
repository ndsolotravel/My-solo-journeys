...
import { u as useTranslations, a as useLanguage, c as Route$C, b as useContentTranslation } from "./router-B6m4P0F8.mjs";
import { P as PageBreadcrumbs } from "./PageBreadcrumbs-FibhKiyH.mjs";
import { T as TranslatedMarkdown } from "./TranslatedMarkdown-JAXIFYCC.mjs";
...
function DisclaimerPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "banner-hover relative h-[30vh] min-h-[220px] w-full overflow-hidden flex flex-col justify-center items-center", children: [
      heroImage ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImage, alt: localizedPage.title, className: "absolute inset-0 h-full w-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 h-full w-full bg-zinc-900" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-brand px-3.5 py-1 text-xs font-medium uppercase tracking-[0.2em] text-brand-foreground shadow-sm mb-3", children: t("Legal") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-5xl font-bold text-white tracking-tight drop-shadow-md", children: localizedPage.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageBreadcrumbs, { items: [{
          label: localizedPage.title
        }] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "prose prose-gray dark:prose-invert max-w-none text-base leading-relaxed text-muted-foreground prose-headings:font-bold prose-headings:text-foreground prose-a:text-brand hover:prose-a:underline prose-strong:text-foreground prose-ul:list-disc prose-ol:list-decimal space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TranslatedMarkdown, { content: localizedPage.content }) }) })
  ] });
}
export {
