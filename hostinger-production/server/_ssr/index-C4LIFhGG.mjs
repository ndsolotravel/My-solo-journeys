...
import { u as useTranslations, z as popularQO, A as guidesQO, N as NewsletterForm, w as postsQO, x as featuredQO, y as destQO$2, B as galleryQO, D as motoQO, E as journeyStatsQO } from "./router-C1QTtW_a.mjs";
...
import "../_libs/ws.mjs";
import { E as Earth, B as Bike, n as Camera, R as Route, o as Calendar, S as Search, p as ArrowRight, q as Compass, r as Mountain, f as MapPin, s as Map } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-t border-border bg-muted/20 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-4", children: destinations.length === 0 ? Array.from({
        ...
        slug: d.slug
      }, className: "group block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] sm:aspect-[3/4] overflow-hidden rounded-2xl bg-muted", children: [
