...
import { u as useTranslations, a as useLanguage, q as Route$p, b as useContentTranslation, r as listPhotoArchive } from "./router-B6m4P0F8.mjs";
import { B as BreadcrumbJsonLd, P as PageBreadcrumbs } from "./PageBreadcrumbs-FibhKiyH.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { x as ChevronLeft, am as Tag, o as MapPin, v as Calendar, r as Camera, d as Sparkles, p as ChevronRight } from "../_libs/lucide-react.mjs";
...
function PhotoDetailPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/gallery", className: "mb-6 inline-flex items-center gap-1.5 text-xs font-medium text-link transition-colors hover:text-link-hover", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "group relative overflow-hidden rounded-3xl border border-border bg-zinc-950 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: photo.image_url, alt: localizedPhoto.alt_text || localizedPhoto.title, className: "h-auto max-h-[82vh] w-full object-contain" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-7", children: [
        photo.categories.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex flex-wrap items-center gap-2", children: [
          ...
          photo.categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/gallery", search: {
            category: cat.slug
          }, className: "rounded-full border border-accent/30 bg-accent/10 px-3 py-1 text-[11px] font-medium text-accent transition-colors hover:bg-accent hover:text-accent-foreground", children: t(cat.name) }, cat.id))
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold leading-tight text-heading sm:text-3xl", children: localizedPhoto.title }),
        (photo.location || photo.captured_at || photo.camera) && /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "mt-5 space-y-2.5 border-t border-border/60 pt-5 text-sm", children: [
          localizedPhoto.location && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-foreground", children: localizedPhoto.location })
          ] }),
          ...
          photo.camera && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-muted-foreground", children: localizedPhoto.camera })
          ] })
        ] }),
        localizedPhoto.story && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 border-t border-border/60 pt-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "whitespace-pre-line text-sm leading-relaxed text-foreground/85", children: localizedPhoto.story })
        ] }),
        (prev || next) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-2 gap-3 border-t border-border/60 pt-5", children: [
          prev ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/gallery/$slug", params: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "line-clamp-2 text-xs font-medium text-heading transition-colors group-hover:text-link-hover", children: t(prev.title) })
            ] })
          ...
          next ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/gallery/$slug", params: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex items-center justify-end gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "line-clamp-2 text-xs font-medium text-heading transition-colors group-hover:text-link-hover", children: t(next.title) }),
    ...
    primaryCategory && related.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-1 mb-5 font-display text-xl font-bold text-heading", children: [
        t("In"),
        " ",
