...
import { computeJourneyCountries } from "./posts.functions-BpiszHs6.mjs";
...
const HOMEPAGE_DEFAULTS = {
  ...
  homepage_hero_description: "First-hand solo expeditions, motorcycle journeys, and high-altitude trekking diaries from Pakistan, the Karakoram, and remote mountain frontiers.",
