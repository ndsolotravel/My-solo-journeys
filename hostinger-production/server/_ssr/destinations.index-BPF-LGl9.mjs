...
import { u as useTranslations, j as destQO$1, k as heroQO } from "./router-DbNDlpj2.mjs";
...
import "../_libs/ws.mjs";
import { V as Map, P as LayoutGrid } from "../_libs/lucide-react.mjs";
...
function DestinationsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "banner-hover relative h-[45vh] min-h-[280px] w-full overflow-hidden", children: [
      hero?.image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: hero.image, alt: "Your destinations in one beautiful image.", className: "absolute inset-0 h-full w-full object-cover object-center" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 h-full w-full bg-zinc-900" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "interactive-map", "aria-labelledby": "explore-heading", className: "mt-12 scroll-mt-24", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: view === "map" ? /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[480px] w-full animate-pulse rounded-2xl border border-border bg-muted/30" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-hidden rounded-2xl border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DestinationsMap, { destinations }) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3", children: destinations.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          d.featured_image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: d.featured_image, alt: d.title, loading: "lazy", className: "h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full w-full items-center justify-center bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "No image" }) }),
