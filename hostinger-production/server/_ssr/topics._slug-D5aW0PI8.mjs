...
import { u as useTranslations, o as Route$r } from "./router-B6m4P0F8.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import "../_libs/sonner.mjs";
import { ac as BookOpen, u as ArrowLeft } from "../_libs/lucide-react.mjs";
...
function TopicPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner-hover relative h-[55vh] min-h-[380px] w-full overflow-hidden", children: [
      (() => {
        const img = topic.posts[0]?.cover_image || topic.heroImage || "";
        return img ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img, alt: topic.title, className: "h-full w-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 h-full w-full bg-zinc-900" });
      })(),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 mx-auto max-w-4xl px-4 pb-12 text-white sm:px-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 font-display text-3xl font-semibold leading-tight sm:text-5xl", children: t(topic.title) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-12 max-w-4xl px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose-blog", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TranslatedMarkdown, { content: topic.pillarContent }) }),
      topic.posts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-2xl font-semibold", children: [
            t("Related Stories"),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-sans tabular-nums font-semibold", children: [
              "(",
              topic.posts.length,
              ")"
            ] })
