...
import { a as useServerFn } from "./router-50q_1crC.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { j as adminListDestinations, k as adminUpsertDestination, l as adminDeleteDestination, b as adminUploadImage } from "./admin.functions-DwpNeojB.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { ac as Plus, f as MapPin, ad as Pencil, a3 as Trash2, X, b as LoaderCircle, a4 as Upload } from "../_libs/lucide-react.mjs";
...
function AdminDestinations() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: (data ?? []).map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition-all hover:border-accent/40", children: [
      d.featured_image ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: d.featured_image, alt: d.title, className: "aspect-video w-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video w-full bg-muted flex items-center justify-center text-muted-foreground text-xs", children: "No featured image" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1 font-display text-base font-semibold", children: d.title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2 border-t border-border/60 pt-3", children: [
