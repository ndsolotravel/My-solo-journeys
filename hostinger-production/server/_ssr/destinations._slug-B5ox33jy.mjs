...
import { t as Route$m, u as useTranslations, a as useLanguage, b as useContentTranslation } from "./router-BuJVAroo.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 -mt-8 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 rounded-2xl border border-border bg-card p-4 sm:p-6 shadow-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-display text-lg font-bold text-foreground", children: localizedDest.country })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-display text-lg font-bold text-foreground", children: localizedDest.region ? localizedDest.region : "—" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-3xl px-4 py-16 sm:px-6", children: localizedDest.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl leading-relaxed text-muted-foreground font-display", children: localizedDest.description }) }),
