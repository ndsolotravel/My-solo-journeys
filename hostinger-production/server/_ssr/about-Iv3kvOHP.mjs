...
import { u as useTranslations, g as settingsQO } from "./router-B6m4P0F8.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { c as useSuspenseQuery } from "../_libs/tanstack__react-query.mjs";
import { A as ABOUT_DEFAULTS, D as DEFAULT_HERO_BADGES, p as parseJson, a as aboutPortrait, b as DEFAULT_DOSSIER_ITEMS, c as DEFAULT_WHY_TRAVEL_CARDS, d as DEFAULT_MOTORCYCLE_FEATURES, e as DEFAULT_TREKKING_CARDS, f as DEFAULT_PHILOSOPHY_CARDS, g as DEFAULT_NUMBER_STATS, h as DEFAULT_TERRAIN_TAGS, i as DEFAULT_CONTENT_CARDS } from "./about.functions-BL2Zcdj1.mjs";
import { r as resolveMediaUrl } from "./media-5OPpyOwL.mjs";
import { B as BreadcrumbJsonLd, P as PageBreadcrumbs } from "./PageBreadcrumbs-FibhKiyH.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { N as Compass, d as Sparkles, O as Shield, o as MapPin, W as Wrench, h as ArrowRight, Q as Send, V as Bike, Z as Route, _ as Mountain, y as CircleCheck, $ as Quote, G as Globe, a0 as Layers, a1 as Flag, a2 as Settings, a3 as Users, a4 as Share2, E as Eye, n as FileText, a5 as Coffee, a6 as Target, a7 as Flame, l as Sun, a8 as Award, a9 as Activity, aa as Zap, ab as Tent, ac as BookOpen, a as Search, U as User, v as Calendar, ad as Navigation, ae as Heart, r as Camera } from "../_libs/lucide-react.mjs";
...
function DynamicIcon({
  ...
  if (!name || typeof name !== "string") return /* @__PURE__ */ jsxRuntimeExports.jsx(Fallback, { className });
...
function AboutPage() {
  ...
  const heroBadges = (parseJson(settings?.about_hero_badges, DEFAULT_HERO_BADGES) || DEFAULT_HERO_BADGES).filter((b) => Boolean(b && b.enabled));
  ...
  const rawBiography = settings?.about_biography_paragraphs?.trim() || ABOUT_DEFAULTS.about_biography_paragraphs;
  const biographyParagraphs = rawBiography.split("\n\n").map((p) => p.trim()).filter(Boolean);
  ...
  const dossierItems = (parseJson(settings?.about_profile_dossier, DEFAULT_DOSSIER_ITEMS) || DEFAULT_DOSSIER_ITEMS).filter((d) => Boolean(d && d.enabled));
  ...
  const whyTravelCards = (parseJson(settings?.about_why_travel_cards, DEFAULT_WHY_TRAVEL_CARDS) || DEFAULT_WHY_TRAVEL_CARDS).filter((c) => Boolean(c && c.enabled)).sort((a, b) => (Number(a?.order) || 0) - (Number(b?.order) || 0));
  ...
  const motorcycleFeatures = (parseJson(settings?.about_motorcycle_features, DEFAULT_MOTORCYCLE_FEATURES) || DEFAULT_MOTORCYCLE_FEATURES).filter((f) => Boolean(f && f.enabled)).sort((a, b) => (Number(a?.order) || 0) - (Number(b?.order) || 0));
  ...
  const trekkingCards = (parseJson(settings?.about_trekking_cards, DEFAULT_TREKKING_CARDS) || DEFAULT_TREKKING_CARDS).filter((c) => Boolean(c && c.enabled)).sort((a, b) => (Number(a?.order) || 0) - (Number(b?.order) || 0));
  ...
  const philosophyCards = (parseJson(settings?.about_philosophy_cards, DEFAULT_PHILOSOPHY_CARDS) || DEFAULT_PHILOSOPHY_CARDS).filter((c) => Boolean(c && c.enabled)).sort((a, b) => (Number(a?.order) || 0) - (Number(b?.order) || 0));
  ...
  const numbersStats = (parseJson(settings?.about_numbers_stats, DEFAULT_NUMBER_STATS) || DEFAULT_NUMBER_STATS).filter((s) => Boolean(s && s.enabled)).sort((a, b) => (Number(a?.order) || 0) - (Number(b?.order) || 0));
  const numbersTagsLabel = settings?.about_numbers_tags_label || ABOUT_DEFAULTS.about_numbers_tags_label;
  const numbersTags = (parseJson(settings?.about_numbers_tags, DEFAULT_TERRAIN_TAGS) || DEFAULT_TERRAIN_TAGS).filter((tItem) => Boolean(tItem && tItem.enabled)).sort((a, b) => (Number(a?.order) || 0) - (Number(b?.order) || 0));
  ...
  const contentCards = (parseJson(settings?.about_content_cards, DEFAULT_CONTENT_CARDS) || DEFAULT_CONTENT_CARDS).filter((c) => Boolean(c && c.enabled)).sort((a, b) => (Number(a?.order) || 0) - (Number(b?.order) || 0));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen w-full overflow-x-clip bg-background text-foreground selection:bg-brand/20 selection:text-brand", children: [
    ...
    heroEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "banner-hover relative min-h-[26vh] lg:min-h-[30vh] w-full flex items-end overflow-hidden bg-zinc-950", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0 overflow-hidden", children: [
        heroImage ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImage, alt: heroImageAlt, loading: "eager", fetchPriority: "high", referrerPolicy: "no-referrer", className: "h-full w-full object-cover object-center transform motion-safe:animate-fade-in duration-1000" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-zinc-900" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-full max-w-7xl mx-auto px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-8 lg:pb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          duration: 0.5
        }, className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-semibold uppercase tracking-[0.2em] text-accent", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.h1, { initial: {
          ...
          duration: 0.6,
          delay: 0.1
        }, className: "font-display text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-[1.1]", children: t(heroHeadline) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { initial: {
          ...
          duration: 0.6,
          delay: 0.2
        }, className: "text-base sm:text-lg text-zinc-300 leading-relaxed max-w-2xl font-light", children: t(heroSubtitle) }),
        heroBadges.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          duration: 0.6,
          delay: 0.3
        }, className: "flex flex-wrap gap-2 pt-1", children: heroBadges.map((badge) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-black/40 border border-white/10 text-xs font-medium text-white/90 backdrop-blur-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DynamicIcon, { name: badge.icon, className: "w-3.5 h-3.5 text-accent", fallback: Compass }),
          t(badge.label)
        ] }, badge.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageBreadcrumbs, { items: [{
          label: "About"
        }] }) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 space-y-24", children: [
      profileEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-12 lg:gap-16 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 space-y-6", children: [
          ...
          dossierItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border/60 bg-card p-6 shadow-sm space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pb-3 border-b border-border/60", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-bold uppercase tracking-wider text-heading", children: t("Expedition Dossier") })
            ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 space-y-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-heading tracking-tight leading-tight", children: t(biographyTitle) })
          ] }),
      ...
      whyTravelEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-3xl mx-auto space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-heading tracking-tight", children: t(whyTravelTitle) }),
        ...
        whyTravelCards.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8", children: whyTravelCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-border/80 bg-card p-8 shadow-sm hover:shadow-md transition-shadow space-y-4 relative overflow-hidden group", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-heading", children: t(card.title) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: t(card.description) })
        ] }, card.id)) })
      ] }),
      motorcycleEnabled && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rounded-3xl border border-border/80 bg-zinc-950 text-white overflow-hidden shadow-2xl isolate", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 items-stretch", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-6 relative h-[360px] sm:h-[440px] lg:h-auto lg:min-h-[540px] w-full overflow-hidden rounded-t-3xl lg:rounded-l-3xl lg:rounded-tr-none lg:rounded-br-none isolate", children: [
          motorcycleImage ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: motorcycleImage, alt: motorcycleImageAlt, loading: "eager", referrerPolicy: "no-referrer", className: "absolute inset-0 block h-full w-full max-w-none object-cover object-center" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-zinc-900" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 z-10 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/20 text-xs font-semibold uppercase tracking-wider text-accent pointer-events-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bike, { className: "w-3.5 h-3.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t(motorcycleBadge) })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-6 p-8 sm:p-12 lg:p-14 space-y-6 flex flex-col justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white tracking-tight leading-tight", children: t(motorcycleTitle) })
          ] }),
      ...
      trekkingEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid lg:grid-cols-12 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-6 space-y-6 order-2 lg:order-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-heading tracking-tight leading-tight", children: t(trekkingTitle) })
          ] }),
          ...
          trekkingCards.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4 pt-2", children: trekkingCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-2xl border border-border/80 bg-card space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-semibold text-heading text-sm flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-6 order-1 lg:order-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-border shadow-xl", children: [
          trekkingImage ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: trekkingImage, alt: trekkingImageAlt, className: "w-full aspect-[4/3] object-cover object-center transition-transform duration-700 hover:scale-[1.03]" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full aspect-[4/3] bg-zinc-900" }),
      ...
      philosophyEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-[2.5rem] bg-gradient-to-br from-card via-muted/30 to-card border border-border/80 p-8 sm:p-12 lg:p-16 text-center shadow-lg overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl mx-auto space-y-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "font-display text-2xl sm:text-3xl lg:text-4xl font-bold text-heading leading-tight tracking-tight", children: [
              "“",
              t(philosophyQuote),
              "”"
            ] }),
        ...
        philosophyCardsEnabled && philosophyCards.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: philosophyCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-2xl border border-border/80 bg-card space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-base text-heading", children: t(card.title) }),
      ...
      numbersEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl sm:rounded-3xl border border-border/80 bg-muted/30 p-3.5 min-[360px]:p-4 sm:p-12 space-y-6 sm:space-y-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 pb-5 sm:pb-6 border-b border-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-accent", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl sm:text-4xl font-bold text-heading tracking-tight", children: t(numbersTitle) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-md", children: t(numbersDescription) })
        ] }),
        numbersStats.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-2.5 min-[380px]:gap-3 sm:gap-6", children: numbersStats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 min-[380px]:p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-card border border-border/80 flex flex-col justify-start space-y-1 sm:space-y-1.5 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans tabular-nums text-[1.35rem] min-[360px]:text-[1.65rem] min-[400px]:text-3xl sm:text-5xl font-bold text-brand tracking-tight whitespace-nowrap leading-none", children: stat.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs sm:text-sm font-bold text-heading leading-snug break-words", children: t(stat.label) }),
          stat.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] sm:text-xs text-muted-foreground leading-relaxed break-words", children: t(stat.description) })
        ] }, stat.id)) }),
        numbersTags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: numbersTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg bg-card border border-border/80 text-[11px] sm:text-xs font-medium text-foreground/90 shadow-2xs hover:border-accent/40 transition-colors", children: t(tag.name) }, tag.id)) })
        ] })
      ] }),
      contentEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-3xl mx-auto space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-heading tracking-tight", children: t(contentTitle) }),
        ...
        contentCards.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-6", children: contentCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: card.ctaUrl, className: "group p-6 rounded-3xl border border-border/80 bg-card hover:border-accent/40 hover:shadow-xl transition-all duration-300 flex flex-col justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-heading group-hover:text-link-hover transition-colors", children: t(card.title) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-muted-foreground leading-relaxed", children: t(card.description) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-6 flex items-center text-xs font-semibold text-link group-hover:text-link-hover gap-1 group-hover:translate-x-1 transition-transform", children: [
      ...
      ctaEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-zinc-900 via-black to-zinc-950 text-white p-8 sm:p-14 lg:p-16 border border-white/10 shadow-2xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight leading-tight", children: t(ctaTitle) }),
