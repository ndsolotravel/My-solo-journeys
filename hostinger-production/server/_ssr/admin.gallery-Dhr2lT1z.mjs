...
import { c as useServerFn } from "./router-dLf4MjiT.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { j as adminListGalleries, k as adminSavePostGallery, l as adminDeleteGalleryImage, c as adminUploadImage } from "./admin.functions-DiyyO5cG.mjs";
...
import { H as HeroBannerManager } from "./HeroBannerManager-DO6SWrHL.mjs";
import { r as resolveMediaUrl } from "./media-DUkNwMwq.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { a6 as Image, $ as ExternalLink, h as LoaderCircle, ar as Upload, z as Layers, b as Sparkles, S as Search, aN as FileImage, aO as GripVertical, aH as Maximize2, o as ChevronLeft, n as ChevronRight, ao as Trash2, X } from "../_libs/lucide-react.mjs";
...
function AdminGalleryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-7xl mx-auto pb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: "Gallery Management" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Add, inspect, reorder, and remove photo galleries across your solo travel stories." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2.5", children: [
        activePost && /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/admin/posts/$id", params: {
          id: activePost.id
        }, className: "inline-flex items-center gap-1.5 rounded-xl border border-border bg-card px-3.5 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors shadow-2xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3.5 w-3.5 text-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Edit Full Story" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => fileInputRef.current?.click(), disabled: uploading, className: "inline-flex items-center gap-2 rounded-xl bg-brand px-5 py-2 text-xs font-semibold text-white shadow-md shadow-brand/20 hover:bg-brand/90 disabled:opacity-50 transition-all cursor-pointer", children: uploading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Upload Pictures" })
        ] }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(HeroBannerManager, { page: "gallery", autoHint: "Automatically uses a suitable photo from the gallery content.", manualHint: "Pick a gallery photo from the CMS below, upload one, or paste a URL.", optionsLabel: "Gallery Photos" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-1 sm:max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: selectedPostId, onChange: (e) => setSelectedPostId(e.target.value), className: "w-full rounded-xl border border-border bg-background px-3.5 py-2 text-xs outline-none focus:border-accent focus:ring-1 focus:ring-accent font-medium transition-colors", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 sm:max-w-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Search photos & captions…", className: "w-full rounded-xl border border-border bg-background pl-9 pr-4 py-2 text-xs outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 border-b border-border/60 pb-4", children: [
        ...
        activePost && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-accent/10 px-2.5 py-0.5 text-xs font-medium text-accent border border-accent/20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: galleryUrlInput, onChange: (e) => setGalleryUrlInput(e.target.value), placeholder: "…or paste direct image web URL (https://…)", className: "flex-1 rounded-xl border border-border bg-background px-3.5 py-2 text-xs outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: handleAddUrl, className: "inline-flex items-center gap-1.5 rounded-xl border border-border bg-card px-3.5 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors shadow-2xs cursor-pointer whitespace-nowrap", children: "Add URL" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTarget, onOpenChange: (open) => !open && setDeleteTarget(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "rounded-3xl border border-border bg-card shadow-2xl p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display text-lg font-bold text-foreground", children: "Remove picture from gallery?" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { className: "mt-4 flex items-center justify-end gap-2.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { className: "rounded-xl bg-red-600 px-4 py-2 text-xs font-semibold text-white shadow-md hover:bg-red-700 transition-all cursor-pointer", onClick: confirmRemove, children: "Remove Picture" })
      ] })
    ] }) }),
