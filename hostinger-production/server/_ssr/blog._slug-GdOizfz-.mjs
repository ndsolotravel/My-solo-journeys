...
import { t as Route$d, v as authorNameQO, g as useLanguage, u as useTranslations, N as NewsletterForm, a as useServerFn } from "./router-C1QTtW_a.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { b as useQuery, u as useQueryClient, c as useMutation } from "../_libs/tanstack__react-query.mjs";
import { t as createSsrRpc } from "./admin.functions-C2WAczeU.mjs";
import { c as createServerFn } from "./server-7Z2Wk8DL.mjs";
import { P as PostCard } from "./PostCard-BYJ8SHAz.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import "../_libs/ws.mjs";
import "../_libs/seroval.mjs";
import { x as ArrowLeft, f as MapPin, U as User, o as Calendar, k as Clock, y as List, z as Image, X, g as ChevronLeft, h as ChevronRight, p as ArrowRight, N as Navigation, D as Share2, H as Star } from "../_libs/lucide-react.mjs";
...
function BlogPostMap({ locationName, latitude, longitude, title }) {
  ...
  reactExports.useEffect(() => {
    ...
    import("../_libs/leaflet.mjs").then(function(n) {
      ...
      `;
      L.marker([latitude, longitude], { icon: markerIcon, title: locationName || title || "Location" }).addTo(map).bindPopup(popupContent).openPopup();
      mapRef.current = map;
    });
    return () => {
      isMounted = false;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "my-8 overflow-hidden rounded-2xl border border-border bg-card shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border bg-muted/40 px-4 py-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "h-3.5 w-3.5 text-accent" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "pb-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[60vh] min-h-[420px] w-full overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 mx-auto max-w-3xl px-4 pb-12 text-white sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
          ...
          post.location_name && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-accent/20 backdrop-blur-md px-3 py-1 text-xs font-medium text-amber-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3" }),
            " ",
            post.location_name
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-12 max-w-3xl px-4 sm:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose-blog mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { components: {
          h2: ({
            children
          }) => {
