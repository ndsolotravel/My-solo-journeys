...
import { u as useTranslations, a5 as Route$B, a6 as archiveQO, a7 as heroQO$2 } from "./router-B5b4WQf1.mjs";
...
function CinematicGalleryCarousel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-[1720px] mx-auto select-none px-2 sm:px-4 lg:px-8", children: [
    ...
    activePhoto && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 sm:mt-8 max-w-2xl mx-auto px-4 text-center transition-all duration-500 animate-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg sm:text-xl md:text-2xl font-bold text-foreground leading-snug tracking-tight", children: t(activePhoto.title) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[#FF7A00] mt-0.5 sm:mt-1 font-extrabold", children: t(titleHighlight) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function GalleryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground pb-20 sm:pb-28", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mx-auto max-w-3xl px-4 pt-3 pb-1 sm:pt-4 sm:pb-2 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-foreground leading-tight", children: t("My Visual Diary") }),
