...
import { p as Route$q } from "./router-B6m4P0F8.mjs";
import "../_libs/sonner.mjs";
import "./server-7Z2Wk8DL.mjs";
import "../_libs/seroval.mjs";
import "../_libs/ws.mjs";
import { u as ArrowLeft, C as Check, a4 as Share2, a7 as Flame, al as Radio, v as Calendar, z as Clock, af as Earth } from "../_libs/lucide-react.mjs";
...
function NewsDetailPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 text-xs text-muted-foreground mb-4", children: [
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full bg-accent/10 border border-accent/20 px-3 py-1 font-bold text-accent uppercase tracking-wider", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 font-sans tabular-nums text-xs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-heading leading-[1.15]", children: newsItem.title }),
    newsItem.summary && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-2xl border-l-4 border-accent bg-accent/5 p-5 text-base sm:text-lg font-medium text-foreground/90 leading-relaxed italic", children: newsItem.summary }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 pt-8 border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-muted text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Earth, { className: "h-5 w-5 text-accent" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center gap-2 rounded-full bg-btn-bg px-5 py-2 text-xs font-semibold text-btn-text hover:bg-btn-hover transition-colors shadow-sm", children: "Home" })
      ] })
    ] })
  ] });
}
