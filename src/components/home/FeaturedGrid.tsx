      ...
      <div className="flex flex-col gap-3 sm:gap-4 lg:col-span-4 w-full min-w-0">
        {secondaryFeatured.slice(0, 2).map((post, idx) => (
          <motion.article
            ...
            className="group relative flex-1 overflow-hidden rounded-2xl border border-border bg-card shadow-sm cinematic-card hover:border-[#FF7A00]/40 min-h-[160px] sm:min-h-[170px] w-full min-w-0"
          >
            <Link to="/blog/$slug" params={{ slug: post.slug }} className="block h-full w-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/30 transition-opacity duration-300 group-hover:opacity-90" />
              ...
              <div className="relative z-10 flex h-full flex-col justify-between p-4 sm:p-5 text-white min-w-0">
                ...
                <div className="mt-3 min-w-0">
                  <h4 className="font-display text-base sm:text-lg font-bold leading-snug text-white transition-colors duration-300 group-hover:text-[#FF7A00] line-clamp-2 break-words [overflow-wrap:anywhere]">
                    {getPostTitle(post)}
                  </h4>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          <a
            ...
            className="group flex items-center justify-between rounded-xl bg-[#E1306C]/10 px-3 py-2.5 text-xs font-medium text-foreground transition-all duration-300 hover:bg-[#E1306C]/20 hover:translate-x-0.5 min-w-0"
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#E1306C] text-white transition-transform duration-300 group-hover:scale-110">
                <Instagram className="h-3.5 w-3.5" />
              </div>
              <span className="font-semibold truncate">{t("Instagram")}</span>
            </div>
            <span className="text-[11px] font-semibold text-[#E1306C] shrink-0 transition-transform duration-300 group-hover:translate-x-0.5">{t("Follow")} →</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-between rounded-xl bg-[#FF0000]/10 px-3 py-2.5 text-xs font-medium text-foreground transition-all duration-300 hover:bg-[#FF0000]/20 hover:translate-x-0.5 min-w-0"
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#FF0000] text-white transition-transform duration-300 group-hover:scale-110">
                <Youtube className="h-3.5 w-3.5" />
              </div>
              <span className="font-semibold truncate">{t("YouTube")}</span>
            </div>
            <span className="text-[11px] font-semibold text-[#FF0000] shrink-0 transition-transform duration-300 group-hover:translate-x-0.5">{t("Subscribe")} →</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-between rounded-xl bg-foreground/5 px-3 py-2.5 text-xs font-medium text-foreground transition-all duration-300 hover:bg-foreground/10 hover:translate-x-0.5 min-w-0"
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-foreground text-background transition-transform duration-300 group-hover:scale-110">
                <Twitter className="h-3.5 w-3.5" />
              </div>
              <span className="font-semibold truncate">X (Twitter)</span>
            </div>
            <span className="text-[11px] font-semibold text-muted-foreground shrink-0 transition-transform duration-300 group-hover:translate-x-0.5">{t("Follow")} →</span>
          </a>
        </div>
        ...
        <div className="mt-4 rounded-xl border border-border/80 bg-muted/40 p-3 w-full min-w-0">
          ...
          <div className="mt-2.5 grid grid-cols-2 gap-2 text-center">
            <div className="rounded-lg bg-background p-2 border border-border/50 transition-all duration-300 hover:border-[#FF7A00]/40 min-w-0">
