  ...
  useEffect(() => {
    ...
    import("leaflet").then((LModule) => {
      ...
      const pinIcon = L.divIcon({
        ...
        html: `
          <div style="position:relative;display:flex;align-items:center;justify-content:center;">
            <div style="position:absolute;width:22px;height:22px;border-radius:9999px;background:rgba(64,133,255,0.3);animation:ping 2s cubic-bezier(0,0,0.2,1) infinite;"></div>
      ...
      destinations.forEach((d) => {
        ...
        pts.push(c);
        const popup = `
          <div style="min-width:180px;font-family:Roboto,system-ui,-apple-system,sans-serif;padding:2px;">
