      ...
      {activePhoto && (
        <div className="mt-6 sm:mt-8 max-w-2xl mx-auto px-4 text-center transition-all duration-500 animate-fade-in">
          ...
          {activePhoto.location && (
            <div className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-accent tracking-wide mb-2">
          ...
          <h2 className="font-display text-lg sm:text-xl md:text-2xl font-semibold text-heading leading-snug tracking-tight">
            {t(activePhoto.title)}
          </h2>
