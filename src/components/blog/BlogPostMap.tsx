...
export function BlogPostMap({ locationName, latitude, longitude, title }: BlogPostMapProps) {
  ...
  useEffect(() => {
    ...
    import("leaflet").then((LModule) => {
      ...
      const popupContent = `
        <div style="font-family: Inter, system-ui, -apple-system, sans-serif; min-width: 180px; padding: 2px;">
          ${title ? `<p style="font-family: Inter, system-ui, -apple-system, sans-serif; font-size: 14px; font-weight: 600; margin: 0 0 4px; color: #111; line-height: 1.25;">${title}</p>` : ""}
