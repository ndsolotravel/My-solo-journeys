  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
      ...
      <div className="sticky top-16 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border bg-background/95 backdrop-blur-md pb-4 pt-3 shadow-2xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Announcement popup modal, scheduling, and visitor alert controls.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-xl border border-border bg-card px-3.5 py-2 text-xs font-medium text-foreground hover:bg-muted transition-colors shadow-2xs cursor-pointer"
          >
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        {/* Main Settings Form */}
        <form id="public-message-form" onSubmit={handleSubmit} className="space-y-6">
