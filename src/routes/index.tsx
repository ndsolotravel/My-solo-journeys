...
<motion.h1
                 ...
                 className="mt-4 sm:mt-5 max-w-4xl font-display text-3xl sm:text-5xl lg:text-6xl leading-[1.15] sm:leading-[1.12] text-white break-words [overflow-wrap:anywhere]"
               >
               ...
               <motion.p
                 ...
                 className="mt-2 sm:mt-3 max-w-xl text-sm sm:text-base lg:text-lg font-sans text-white/65 leading-relaxed tracking-wide"
               >
