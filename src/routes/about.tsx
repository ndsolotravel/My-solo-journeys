  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        <h2 className="sr-only">Solo, slow, and almost always uphill.</h2>
        ...
        <section className="mt-20">
          <h2 className="font-display text-2xl font-bold">The journey so far</h2>
        ...
        <section className="mt-20 rounded-3xl bg-muted/40 p-8">
          <h2 className="font-display text-2xl font-bold">Travel philosophy</h2>
