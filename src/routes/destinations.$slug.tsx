      ...
      <div className="banner-hover relative h-[65vh] min-h-[440px] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 mx-auto max-w-7xl px-4 pb-12 text-white sm:px-6 lg:px-8">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-1 rounded-full bg-accent/20 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#4085FF] backdrop-blur-md">
            ...
            {otherDestinations.map((item: Destination) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 text-white">
                  ...
                  <h3 className="mt-1 font-display text-xl font-semibold group-hover:text-[#4085FF] transition-colors flex items-center justify-between">
                    {t(item.title)}{" "}
